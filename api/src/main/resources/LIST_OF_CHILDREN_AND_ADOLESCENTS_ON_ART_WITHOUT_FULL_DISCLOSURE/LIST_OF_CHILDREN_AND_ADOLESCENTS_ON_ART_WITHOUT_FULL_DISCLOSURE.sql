                          ...
                          case 
                          when ultimaRevelacao.value_coded = 6338 then 'P' 
                          when ultimaRevelacao.value_coded = 6339 then 'N' 
                          when ultimaRevelacao.value_coded is null then ""
                          end AS CODE,
                          ...
                          inner  join
                          (
                          Select p.patient_id,max(e.encounter_datetime) data_revelacao, o.concept_id, o.value_coded  from patient p  
                          inner join encounter e on p.patient_id=e.patient_id  
                          inner join obs o on o.encounter_id=e.encounter_id 
                          where e.voided=0 and o.voided=0 and p.voided=0 and  
                          e.encounter_type in (35) and o.concept_id=6340 and (o.value_coded in(6338,6339) or o.value_coded is null) and  
                          ...
                          inner join
                          (
                          Select p.patient_id,min(e.encounter_datetime) data_revelacao, o.concept_id, o.value_coded  from patient p  
                          inner join encounter e on p.patient_id=e.patient_id  
                          inner join obs o on o.encounter_id=e.encounter_id 
                          where e.voided=0 and o.voided=0 and p.voided=0 and  
                          e.encounter_type in (35) and o.concept_id=6340 and o.value_coded in(6338) and  
                          e.encounter_datetime<=:endDate and e.location_id=:location 
                          group by p.patient_id 
