						  ...
						  (
							...
							(
								...
								where 	obsRevelado.voided=0 and e.encounter_datetime=maxApss.encounter_datetime and 
										obsRevelado.concept_id=6340 and e.location_id=:location and 
										e.encounter_type=35 and obsRevelado.value_coded in (6338,6339)
                          ...
                          and date_add(coorte12meses_final.data_usar, interval 60 day) >=:endDate and floor(datediff(:endDate,p.birthdate)/365)  between 8 and 14 and revelado.patient_id is null              