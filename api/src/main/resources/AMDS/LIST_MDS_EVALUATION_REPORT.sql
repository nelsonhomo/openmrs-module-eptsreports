  ...
  (
   select 
         ...
         if(tpt.data_tb is null,'SIM','NAO') as elegibilidade_tpt,
         ...
         if((gravidaLactante.gravida_lactante is null or gravidaLactante.gravida_lactante='') ,'NAO', 'SIM') gravida_lactante_12_meses,
    ...
    from 
     ...
     (
        ...
        select * from ( 
            ...
            and  profilaxiaINH.concept_id = 23985  and profilaxiaINH.value_coded in (656,23954,165306) and estadoProfilaxia.concept_id = 165308 and estadoProfilaxia.value_coded = 1256  
    ...
    (
     ...
     left join
     (
      select tb.patient_id,tb.data_tb, if(tb.data_tb is null or tb.data_tb='','NAO','SIM') tuberculose from 
            (
    ...
    select primeiroMdc.patient_id,min(primeiroMdc.data_mdc) data_registo_primeiro_mdc from 
     ...
     (
      ...
      left join
     (
      select pedido.patient_id,min(pedido.data_primeiro_pedido_cv_24_meses) data_primeiro_pedido_cv_24_meses,o.obs_datetime 
      from 
           (
       select p.patient_id,o.obs_datetime data_primeiro_pedido_cv_24_meses
            ...
            inner join obs o on o.person_id=pedido.patient_id and o.concept_id in(1305,856) and o.location_id=:location and o.voided=0 and date(o.obs_datetime)<date(pedido.data_primeiro_pedido_cv_24_meses) 
            GROUP by pedido.patient_id           
      )primeiroPedidoCV24Meses on primeiroPedidoCV24Meses.patient_id=coorteFinal.patient_id and coorteFinal.tipo_coorte=24 and primeiroPedidoCV24Meses.data_primeiro_pedido_cv_24_meses>=coorteFinal.art_start_date
    ...
    left join
     (
      ...
      left join
      (
      select cv.patient_id,min(cv.data_primeiro_resultado_cv_24_meses) data_primeiro_resultado_cv_24_meses,cv.resultado_cv_24_meses,ex.obs_datetime_para_exclusao 
    ...
    from
      ...
      case o.value_coded 
       ...
       -- WHERE  cv.data_primeiro_resultado_cv_24_meses>ex.obs_datetime_para_exclusao
       group by cv.patient_id
      ...
      and resultadoCVPrimeiro24Meses.data_primeiro_resultado_cv_24_meses>=coorteFinal.art_start_date
      and resultadoCVPrimeiro24Meses.obs_datetime_para_exclusao>=coorteFinal.art_start_date
      and resultadoCVPrimeiro24Meses.data_primeiro_resultado_cv_24_meses>resultadoCVPrimeiro24Meses.obs_datetime_para_exclusao
    ...
    (
     ...
     left join
     (
      select tb24Meses.patient_id,tb24Meses.data_tb_24_meses, if(tb24Meses.data_tb_24_meses is null or tb24Meses.data_tb_24_meses='' ,'NAO','SIM') tb_24_meses from 
            (
