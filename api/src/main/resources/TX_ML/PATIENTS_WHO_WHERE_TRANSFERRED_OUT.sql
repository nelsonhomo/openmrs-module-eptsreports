...
where ((data_saida_transferencia is null or (data_saida_transferencia is not null and ultimo_fila > data_saida_transferencia))  and data_entrada_obito is null and data_entrada_transferencia >= ultimo_fila and data_entrada_transferencia <= :endDate and date_add(data_proximo_lev, interval 1 day) >=:startDate) 