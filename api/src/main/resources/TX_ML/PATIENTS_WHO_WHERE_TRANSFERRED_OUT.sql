...
from (
 ...
 where ((data_estado is null or (data_estado is not null and  maximo_ultimo_fila_seguimento > data_estado))  and data_entrada_obito is null and data_entrada_transferencia >= maximo_ultimo_fila_seguimento and data_entrada_transferencia <= :endDate and date_add(maximo_proximo_fila_recepcao, interval 1 day) >=:startDate) 