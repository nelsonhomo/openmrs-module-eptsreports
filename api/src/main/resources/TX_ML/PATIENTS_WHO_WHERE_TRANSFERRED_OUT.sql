...
from (
 ...
 where ((data_estado is null or (data_estado is not null and  data_entrada_transferencia > data_estado))  and data_entrada_obito is null and data_entrada_transferencia >= data_fila and data_entrada_transferencia <= :endDate and date_add(maximo_proximo_fila_recepcao, interval 1 day) >=:startDate)  