...
from (
 ...
 where ( (data_estado is null or (data_estado is not null and  data_fila > data_estado))  and data_entrada_obito >= data_fila and data_entrada_obito between :startDate and :endDate)