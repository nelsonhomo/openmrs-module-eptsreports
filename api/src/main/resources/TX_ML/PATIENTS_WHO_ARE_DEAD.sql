...
where ((data_saida_obito is null or (data_saida_obito is not null and  ultimo_fila > data_saida_obito))  and data_entrada_obito >= ultimo_fila and data_entrada_obito between :startDate and :endDate)