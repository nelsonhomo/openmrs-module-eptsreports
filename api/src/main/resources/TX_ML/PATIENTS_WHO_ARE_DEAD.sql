...
from (
 ...
 where ( (data_estado is null or (data_estado is not null and  maximo_ultimo_fila_seguimento > data_estado))  and data_entrada_obito >= maximo_ultimo_fila_seguimento and data_entrada_obito between :startDate and :endDate)