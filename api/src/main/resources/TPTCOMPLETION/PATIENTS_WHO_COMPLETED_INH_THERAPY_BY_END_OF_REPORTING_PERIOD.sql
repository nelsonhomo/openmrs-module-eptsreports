 ...
 from                                                                                                                                                
	...
	(  		
		...
		(	select p.patient_id, o.value_datetime data_final_inh    																		
     	   ...
     	   select p.patient_id, obsFimINH.value_datetime  data_final_inh               														
		     from patient p    																												
		     	inner join encounter e on p.patient_id=e.patient_id        																	
		        inner join obs o on o.encounter_id=e.encounter_id 
		      ...
		      where p.voided=0 and e.voided=0 and o.voided=0 and e.encounter_type=53 and o.concept_id=23985 and o.value_coded=656            
		      	and e.encounter_datetime<= :endDate and e.location_id= :location 
		      	and obsFimINH.voided=0 and obsFimINH.concept_id=6129
        ...
        select p.patient_id,e.encounter_datetime data_final_inh               														
		     from patient p    																												
		        ...
		        inner join obs o on o.encounter_id=e.encounter_id 
		        inner join obs obsFimINH on obsFimINH.encounter_id=e.encounter_id             															
		      where p.voided=0 and e.voided=0 and o.voided=0 and e.encounter_type=6 and o.concept_id=23985 and o.value_coded=656            
		      	and e.encounter_datetime<= :endDate and e.location_id= :location
		      	and obsFimINH.voided=0 and obsFimINH.concept_id=165308 and obsFimINH.value_coded=1267
  		) endINH                																													
) termino_inh  																																	
			...
			(	
	          ...
	          select p.patient_id,e.encounter_datetime data_final_inh               														
			     from patient p    																												
			      ...
			      where p.voided=0 and e.voided=0 and o.voided=0 and e.encounter_type=6 and o.concept_id=23985 and o.value_coded=656            
			      	and e.encounter_datetime<= :endDate and e.location_id= :location
			      	and obsFimINH.voided=0 and obsFimINH.concept_id=165308 and obsFimINH.value_coded in (1256, 1257)
	    ) endINH                																													
	) termino_inh  																																	
		on inicio_inh.patient_id=termino_inh.patient_id 
	where termino_inh.data_final_inh between inicio_inh.data_inicio_inh and (inicio_inh.data_inicio_inh + INTERVAL 4 MONTH)
      group by termino_inh.patient_id,inicio_inh.data_inicio_inh having count(*)>=5
