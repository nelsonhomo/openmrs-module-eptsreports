		...
		(
			/*
				...
				*/
				...
				where 	e.voided=0 and p.voided=0 and obs3hpStart.value_datetime between (:endDate - interval 7 month) and :endDate and  										
					...
					(  																																	
					   ...
					   union 
						...
						where 	p.voided=0 and e.voided=0 and o.voided=0 and e.encounter_type=60  and o.concept_id=23985 and o.value_coded in (23954,23984)  	
								and	e.encounter_datetime between (:endDate - INTERVAL 20 MONTH) and :endDate  and e.location_id= :location		 	 			
					)  																																		
				...
				*/		
				...
				(  																																		
					...
					from 	patient p  																													
							...
							inner join obs obs3hp on obs3hp.encounter_id=e.encounter_id 
							inner join obs obs3hpStart on obs3hpStart.encounter_id=e.encounter_id 
					where 	e.voided=0 and p.voided=0 and obs3hpStart.value_datetime between (:endDate - interval 20 month) and :endDate and  										
							obs3hp.voided=0 and obs3hp.concept_id=23985 and obs3hp.value_coded=23954 and e.encounter_type=53 and  
							e.location_id=:location and obs3hpStart.concept_id=6128 and obs3hpStart.voided=0			 
				)  																																			
	...
	(
		...
		/*
			...
			*/
			...
			where 	e.voided=0 and p.voided=0 and obsInhStart.value_datetime between (:endDate - interval 7 month) and :endDate and  										
			  ...
			  from  																																	
				...
				( 	
					...
					from 	patient p  																														
							inner join encounter e on p.patient_id=e.patient_id  																				
							inner join obs o on o.encounter_id=e.encounter_id  																					
					where 	e.voided=0 and p.voided=0 and e.encounter_datetime between (:endDate - interval 23 month) and :endDate  												
							and o.voided=0 and o.concept_id=6122 and o.value_coded=1256 and e.encounter_type in (6,9) and  e.location_id=:location 
					...
					from 	patient p  																														
							...
							inner join obs o on o.encounter_id=e.encounter_id 
							 left join obs regimeTPT on (regimeTPT.encounter_id  = e.encounter_id and  regimeTPT.concept_id = 23985 and regimeTPT.voided = 0) 																					
					where 	e.voided=0 and p.voided=0 and o.value_datetime between (:endDate - interval 23 month) and :endDate  													
							and o.voided=0 and o.concept_id=6128 and e.encounter_type in (53,6,9) and e.location_id=:location 
							and regimeTPT.person_id is null
					...
					from 	patient p  																													
							...
							inner join obs obsInh on obsInh.encounter_id=e.encounter_id 
							inner join obs obsInhStart on obsInhStart.encounter_id=e.encounter_id 
					where 	e.voided=0 and p.voided=0 and obsInhStart.value_datetime between (:endDate - interval 23 month) and :endDate and  										
							obsInh.voided=0 and obsInh.concept_id=23985 and obsInh.value_coded=656 and e.encounter_type=53 and  
							e.location_id=:location and obsInhStart.concept_id=6128 and obsInhStart.voided=0
