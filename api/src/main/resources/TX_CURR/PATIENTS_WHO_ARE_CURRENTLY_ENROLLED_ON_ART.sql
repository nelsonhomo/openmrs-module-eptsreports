   select patient_id                                                                                                   
            ...
            (select inicio.*,                                                                                                                    
             ...
             ( 
                ...
                ) ultimo_levantamento on ultimo_levantamento.patient_id = allSaida.patient_id 
               where ultimo_levantamento.data_ultimo_levantamento is null or  ultimo_levantamento.data_ultimo_levantamento <= :endDate
