...
where e.voided=0 and o.voided=0 and p.voided=0 and                                                                
      ...
      and o.value_coded in(664,1065)  and e.location_id= :location 
      and  e.encounter_datetime  between :startDate and :endDate
union
...
from    patient p                                                                                                   
      ...
      inner join obs o on o.encounter_id=e.encounter_id
where e.voided=0 and o.voided=0 and p.voided=0 and                                                            
      e.encounter_type=6 and o.concept_id in(23723,23774,23951,307.12) and o.value_coded in(703,664,21233,1118,1067,1138,23956)
      and e.location_id= :location and e.encounter_datetime between :startDate and :endDate
union
...
from    patient p                                                                                                   
      ...
      inner join obs o on o.encounter_id=e.encounter_id
where e.voided=0 and o.voided=0 and p.voided=0 and                                                            
      e.encounter_type=13 and o.concept_id in(307,23723,23774,23951) and o.value_coded in(703,664)
      and e.location_id= :location and e.encounter_datetime between :startDate and :endDate
...
from    patient p                                                                                                   
      ...
      inner join obs o on o.encounter_id=e.encounter_id
where e.voided=0 and o.voided=0 and p.voided=0 and                                                            
      e.encounter_type=13 and o.concept_id in(307) and o.value_coded in(165184)
      and e.location_id= :location and e.encounter_datetime between :startDate and :endDate
union
