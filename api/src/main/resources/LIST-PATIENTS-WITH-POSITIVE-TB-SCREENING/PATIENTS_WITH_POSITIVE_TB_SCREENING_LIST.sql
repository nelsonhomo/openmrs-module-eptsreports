select coorte12meses_final.patient_id as patient_id,
    ...
    where (data_estado is null or (data_estado is not null and  data_usar_c>data_estado)) and date_add(data_usar, interval 28 day) >=:endDate  and tbTretment6Months.patient_id is null
