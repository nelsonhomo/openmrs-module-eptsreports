            select result_.patient_id from (
            select inicio_tarv.patient_id from (	
                ...
                (
                	...
                	where inicio_tarv.art_start_date >= inscricao_tarv.art_enrolled_date and (TIMESTAMPDIFF(DAY,inscricao_tarv.art_enrolled_date , inicio_tarv.art_start_date)) <= 15 
			)result_