...
(	
	select 		
			...
			HVL_FR40.dataInicioNovaLinhaCV1,
	...
	(
						...
						(
							...
							(
								...
								(
									...
									(
																				...
																				from
																					...
																					(		
																							...
																							from
																											...
																											if(min(consultaApss3.encounter_datetime) is not null,min(consultaApss3.encounter_datetime),
																												if(dataConsultaApss2 is not null, dataConsultaApss2,
																													if(dataConsultaApss1 is not null,dataConsultaApss1,
																														if(dataConsultaApss0 is not null ,dataConsultaApss0,null)))) dataApssAvaliarAdesao
																									from
																									(
																										select 	HVL_FR16.*,
																								...
																								) avalidacaoAdesao on avalidacaoAdesao.patient_id=HVL_FR19.patient_id and avalidacaoAdesao.dataApssAvaliarAdesao=HVL_FR19.dataApssAvaliarAdesao
										...
										left join encounter consultaApss2CV1 on consultaApss2CV1.patient_id=HVL_FR28.patient_id and 
														...
														consultaApss2CV1.encounter_datetime BETWEEN HVL_FR28.dataConsultaApss2CV0 and :endDate
									...
									left join encounter consultaApss2CV2 on consultaApss2CV2.patient_id=HVL_FR29.patient_id and 
														...
														consultaApss2CV2.encounter_datetime BETWEEN HVL_FR29.dataConsultaApss2CV1 and :endDate
								...
								left join encounter consultaApss2CV3 on consultaApss2CV3.patient_id=HVL_FR30.patient_id and 
														...
														consultaApss2CV3.encounter_datetime BETWEEN HVL_FR30.dataConsultaApss2CV2 and :endDate
	 ...
	 inner join person p on p.person_id=HVL_FR40.patient_id          
	  ...
	  left join person_attribute pat on pat.person_id=HVL_FR40.patient_id and pat.person_attribute_type_id=9 and pat.value is not null and pat.value<>'' and pat.voided=0
	   left join person_attribute pat2 on pat.person_id=HVL_FR40.patient_id and pat.person_attribute_type_id=30 and pat.value is not null and pat.value<>'' and pat.voided=0
	left join
	( 
...
(	
	select 		
         ...
         pad3.address3 as 'celula', 
			...
			HVL_FR40.dataPrevistaConsultaMudancaLinhaCV2, 
			HVL_FR40.dataInicioNovaLinhaCV2,
			if( HVL_FR40.dataPrevistaConsultaMudancaLinhaCV1 >= :endDate and HVL_FR40.dataPrevistaConsultaMudancaLinhaCV1 <= date_add(:endDate, interval 7 day) and HVL_FR40.dataConsultaClinicaParaMudancaLinhaCV1 is null ,'Mudança de Linha - A: Data da consulta Clínica para Mudança de linha', null  ) alert
	from
...
(	
	select 		
         ...
         pad3.address3 as 'celula',  
			...
			HVL_FR40.dataPrevistaConsultaMudancaLinhaCV2, 
			HVL_FR40.dataInicioNovaLinhaCV2,
				if( HVL_FR40.dataPrevistaApss0CV2 >= :endDate and HVL_FR40.dataPrevistaApss0CV2 <= date_add(:endDate, interval 7 day) and HVL_FR40.dataConsultaApss0CV2 is null ,'Aconselhamento para Reforço a Adesão - Seguimento após resposta Comité TARV: Data da Sessão 0 da APSS/PP após segunda CV alta (se aplicável)', null  ) alert
	from
...
(	
	select 		
         ...
         pad3.address3 as 'celula', 
			...
			HVL_FR40.dataPrevistaConsultaMudancaLinhaCV2, 
			HVL_FR40.dataInicioNovaLinhaCV2,
			if( HVL_FR40.dataPrevistaApss1CV2 >= :endDate and HVL_FR40.dataPrevistaApss1CV2 <= date_add(:endDate, interval 7 day) and HVL_FR40.dataConsultaApss1CV2 is null ,'Aconselhamento para Reforço a Adesão - Seguimento após resposta Comité TARV - Data da 1ª Consulta de APSS Após segunda CV Alta', null  ) alert
	from
...
(	
	select 		
         ...
         pad3.address3 as 'celula', 
			...
			HVL_FR40.dataPrevistaConsultaMudancaLinhaCV2, 
			HVL_FR40.dataInicioNovaLinhaCV2,
			if( HVL_FR40.dataPrevistaApss2CV2 >= :endDate and HVL_FR40.dataPrevistaApss2CV2 <= date_add(:endDate, interval 7 day) and HVL_FR40.dataConsultaApss2CV2 is null ,'Aconselhamento para Reforço a Adesão - Seguimento após resposta Comité TARV - Data da 2ª Consulta de APSS/PP Após segunda CV alta:', null  )   alert
	from
...
(	
	select 		
         ...
         pad3.address3 as 'celula', 
			...
			HVL_FR40.dataPrevistaConsultaMudancaLinhaCV2, 
			HVL_FR40.dataInicioNovaLinhaCV2,
			if( HVL_FR40.dataPrevistaApss3CV2 >= :endDate and HVL_FR40.dataPrevistaApss3CV2 <= date_add(:endDate, interval 7 day) and HVL_FR40.dataConsultaApss3CV2 is null ,'Aconselhamento para Reforço a Adesão - Seguimento após resposta Comité TARV - Data da 3ª Consulta de APSS/PP Após CV acima de 1000:', null  )  alert
	from
...
(	
	select 		
         ...
         pad3.address3 as 'celula', 
			...
			HVL_FR40.dataPrevistaConsultaMudancaLinhaCV2, 
			HVL_FR40.dataInicioNovaLinhaCV2,
			if( HVL_FR40.dataPrevistaColheitaAmostraCV2 >= :endDate and HVL_FR40.dataPrevistaColheitaAmostraCV2 <= date_add(:endDate, interval 7 day) and HVL_FR40.dataColheitaRegistadaCV2 is null ,'Repetição da CV - Terceira Carga Viral: Data de Colheita da terceira CV (se aplicável) do Laboratório', null  )  alert
	from
...
(	
	select 		
         ...
         pad3.address3 as 'celula', 
			...
			HVL_FR40.dataPrevistaConsultaMudancaLinhaCV2, 
			HVL_FR40.dataInicioNovaLinhaCV2,
			if( HVL_FR40.dataPrevistaResultadoTerceiraCV >= :endDate and HVL_FR40.dataPrevistaResultadoTerceiraCV <= date_add(:endDate, interval 7 day) and HVL_FR40.dataResultadoTerceiraCV is null ,'Repetição da CV - Terceira Carga Viral: Data de Recepção do resultado da CV (Lab ou FSR)', null  ) alert
	from
...
(	
	select 		
         ...
         pad3.address3 as 'celula', 
			...
			HVL_FR40.dataPrevistaConsultaMudancaLinhaCV2, 
			HVL_FR40.dataInicioNovaLinhaCV2,
			if( HVL_FR40.dataPrevistaConsultaMudancaLinhaCV2 >= :endDate and HVL_FR40.dataPrevistaConsultaMudancaLinhaCV2 <= date_add(:endDate, interval 7 day) and HVL_FR40.dataConsultaClinicaParaMudancaLinhaCV2 is null ,'Mudança da Linha - B: Data da Consulta Clínica para Mudança de Linha)', null  ) alert
	from
