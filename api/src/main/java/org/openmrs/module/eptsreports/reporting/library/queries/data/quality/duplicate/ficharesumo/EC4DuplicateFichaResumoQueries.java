  ...
  class QUERY {
    ...
    public static String findPatientsWithMoreThanOneFilaInTheSameDate =
        "SELECT   "
            ...
            + "from "
            + "( "
            + "SELECT p.patient_id,min(e.encounter_datetime) encounter_datetime_primeira,e.encounter_type encounter_type_primeira,e.encounter_id encounter_id_primeira, e.location_id location_id_primeira, e.date_created "
            ...
            + "inner join "
            + "( "
            + "SELECT p.patient_id,e.encounter_datetime encounter_datetime_qualquer, e.encounter_type encounter_type_qualquer,e.encounter_id encounter_id_qualquer,e.location_id location_id_qualquer "
            + "FROM patient p inner join encounter e on p.patient_id=e.patient_id "
            + "where p.voided=0 and e.voided=0 and e.encounter_type=18 "
            ...
            + "and date(primeira.location_id_primeira)=date(qualquer.location_id_qualquer) "
            + "and date(primeira.encounter_id_primeira)<>date(qualquer.encounter_id_qualquer) "
