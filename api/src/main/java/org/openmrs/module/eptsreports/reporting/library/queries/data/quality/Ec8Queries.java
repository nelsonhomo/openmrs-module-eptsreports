  ...
  public static String getEc8CombinedQuery() {
    String query =
        "SELECT "
            ...
            + "and ((requestLabDate.dataPedidoLab>trasferedOut.data_transferido_para) "
            + "OR "
            + "(colheitaLabDate.dataColheitaLab>trasferedOut.data_transferido_para) "
            + "OR "
            + "(colheitaFSRDate.dataColheitaFSR>trasferedOut.data_transferido_para)) GROUP BY pe.person_id ";
