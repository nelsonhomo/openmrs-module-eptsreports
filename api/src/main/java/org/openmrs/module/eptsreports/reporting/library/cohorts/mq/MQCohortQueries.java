...
public class MQCohortQueries {
  ...
  @DocumentedDefinition(
      value = "findPatientsDiagnosedWithActiveTBDuring6MonthsAfterInitiatedTPIINHCategory7")
  public CohortDefinition
  ...
  @DocumentedDefinition(
      value = "findPatientsWithPositiveTBScreeningDuring6MonthsAfterInitiatedINHCategory7")
  public CohortDefinition
  ...
  @DocumentedDefinition(
      value = "finPatientsWhoHadTBTreatmentDuring6MonthsAfterInitiatedINHCategory7")
  public CohortDefinition finPatientsWhoHadTBTreatmentDuring6MonthsAfterInitiatedINHCategory7() {

    final SqlCohortDefinition definition = new SqlCohortDefinition();

    definition.setName("finPatientsWhoHadTBTreatmentDuring6MonthsAfterInitiatedINHCategory7");
    definition.addParameter(new Parameter("startInclusionDate", "Start Date", Date.class));
    definition.addParameter(new Parameter("endInclusionDate", "End Date", Date.class));
    definition.addParameter(new Parameter("endRevisionDate", "End Revision Date", Date.class));
    definition.addParameter(new Parameter("location", "Location", Location.class));
  ...
  @DocumentedDefinition(
      value = "findPatientsDiagnosedWithActiveTBDuring9MonthsAfterInitiatedTPIINHCategory7")
  public CohortDefinition
      findPatientsDiagnosedWithActiveTBDuring9MonthsAfterInitiatedTPIINHCategory7() {

    final SqlCohortDefinition definition = new SqlCohortDefinition();

    definition.setName("findPatientsDiagnosedWithActiveTBDuring6MonthsAfterInitiatedTPICategory7");
    definition.addParameter(new Parameter("startInclusionDate", "Start Date", Date.class));
    definition.addParameter(new Parameter("endInclusionDate", "End Date", Date.class));
    definition.addParameter(new Parameter("endRevisionDate", "End Revision Date", Date.class));
    definition.addParameter(new Parameter("location", "Location", Location.class));
  ...
  public CohortDefinition finPatientsWhoHadTBTreatmentDuring9MonthsAfterInitiatedINHCategory7() {
    ...
    definition.setName("finPatientsWhoHadTBTreatmentDuring9MonthsAfterInitiatedINHCategory7");
    definition.addParameter(new Parameter("startInclusionDate", "Start Date", Date.class));
    definition.addParameter(new Parameter("endInclusionDate", "End Date", Date.class));
    definition.addParameter(new Parameter("endRevisionDate", "End Revision Date", Date.class));
    definition.addParameter(new Parameter("location", "Location", Location.class));
