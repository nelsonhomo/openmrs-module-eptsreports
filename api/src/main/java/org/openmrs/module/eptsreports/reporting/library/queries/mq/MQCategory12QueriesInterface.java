  ...
  class QUERY {
    ...
    public static final String
        findPatientsWhoStartedARTInTheInclusionPeriodAndReturnedForClinicalConsultation33DaysAfterAtartingARTCategory12 =
            "            SELECT ret33.patient_id "
                + "            FROM "
                + "            ( "
                + "                select tx_new.patient_id,tx_new.art_start_date as art_start_date, ret.dataret33  from "
                + "                ( "
                + "                SELECT patient_id, MIN(art_start_date) art_start_date  FROM ( "
                + "                SELECT p.patient_id, MIN(value_datetime) art_start_date FROM patient p "
                + "                INNER JOIN encounter e ON p.patient_id=e.patient_id "
                ...
                + "                inner join "
                + "                ( "
                + "			       SELECT art_start.patient_id, MIN(art_start_date) art_start_date, consultation.dataret33  FROM ( "
                + "                SELECT p.patient_id, MIN(value_datetime) art_start_date FROM patient p "
                + "                INNER JOIN encounter e ON p.patient_id=e.patient_id "
                + "                INNER JOIN obs o ON e.encounter_id=o.encounter_id "
                + "                WHERE p.voided=0 AND e.voided=0 AND o.voided=0 AND e.encounter_type=53 "
                ...
                + "                )consultation on art_start.patient_id=consultation.patient_id "
                + "                 where consultation.dataret33 BETWEEN   DATE_ADD(art_start.art_start_date, INTERVAL 20 DAY) AND  DATE_ADD(art_start.art_start_date, INTERVAL 33 DAY) "
