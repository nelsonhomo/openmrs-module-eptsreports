...
public class MICategory15DataSet extends MQAbstractDataSet {
  ...
  public void constructTMiDatset(
    ...
    dataSetDefinition.addColumn(
        "CAT15NUMERADOR_15_1",
        "15.13 % de pacientes elegíveis a MDS, que foram inscritos em MDS - NUMERADOR",
        EptsReportUtils.map(
    ...
    dataSetDefinition.addColumn(
        ...
        "15.13 % de pacientes elegíveis a MDS, que foram inscritos em MDS - DENOMINADOR",
        EptsReportUtils.map(
            this.setIndicatorWithAllParameters(
                this.miCategory15CohortQueries
    ...
    dataSetDefinition.addColumn(
        "CAT15NUMERADOR_15_2",
        "15.14 % de inscritos em MDS que receberam CV acima de 1000 cópias que foram suspensos de MDS - NUMERADOR",
        EptsReportUtils.map(
            this.setIndicatorWithAllParameters(
                this.miCategory15CohortQueries
    ...
    dataSetDefinition.addColumn(
        ...
        "15.14 % de inscritos em MDS que receberam CV acima de 1000 cópias que foram suspensos de MDS - DENOMINADOR",
        EptsReportUtils.map(
            this.setIndicatorWithAllParameters(
                this.miCategory15CohortQueries
    ...
    dataSetDefinition.addColumn(
        "CAT15NUMERADOR_15_3",
        "15.15 % de pacientes inscritos em MDS em TARV há mais de 21 meses, que conhecem o seu resultado de CV de seguimento - NUMERADOR",
        EptsReportUtils.map(
            this.setIndicatorWithAllParameters(
                this.miCategory15CohortQueries
    ...
    dataSetDefinition.addColumn(
        ...
        "15.15 % de pacientes inscritos em MDS em TARV há mais de 21 meses, que conhecem o seu resultado de CV de seguimento - DENOMINADOR",
        EptsReportUtils.map(
            this.setIndicatorWithAllParameters(
                this.miCategory15CohortQueries
