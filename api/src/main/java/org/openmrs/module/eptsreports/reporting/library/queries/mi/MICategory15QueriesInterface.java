  ...
  class QUERY {
    ...
    public static final String findPatientsWhoAreActiveOnArtAndInAtleastOneDSD =
        "        select final.patient_id from ( "
            ...
            + "            INNER JOIN encounter e on p.patient_id=e.patient_id "
            + "            where p.voided=0 and e.voided=0 and  e.encounter_type = 6 "
            + "            and e.encounter_datetime  <=:endRevisionDate and e.location_id=:location "
            + "            group by patient_id "
            + "            )maxEnc "
            + "            inner join ( "
            ...
            + "            where  e.encounter_type=6 and o.concept_id=165174 and o.value_coded in(23724) and grupo.concept_id=165323 "
            + "            and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256,1257) and  e.location_id =:location "
            ...
            + "            join obs o on o.encounter_id=e.encounter_id "
            + "            join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "            where  e.encounter_type=6 and o.concept_id=165174 and o.value_coded in(23730) and grupo.concept_id=165323 "
            + "            and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256,1257) and  e.location_id =:location "
            + "            and p.voided=0 and e.voided=0 and o.voided=0 and grupo.voided=0 and obsEstado.voided=0 and e.encounter_datetime<:endRevisionDate "
            + "            )allConsultation ON allConsultation.patient_id = maxEnc.patient_id and allConsultation.encounter_datetime < maxEnc.data "
            + "            )DM "
            ...
            + "            join obs o on o.encounter_id=e.encounter_id "
            + "            join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "            where  e.encounter_type=6 and o.concept_id=165174 and o.value_coded in(23888) and grupo.concept_id=165323 "
            + "            and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256,1257) and  e.location_id =:location "
            + "            and p.voided=0 and e.voided=0 and o.voided=0 and grupo.voided=0 and obsEstado.voided=0 and e.encounter_datetime<:endRevisionDate "
            + "            )allConsultation ON allConsultation.patient_id = maxEnc.patient_id and allConsultation.encounter_datetime < maxEnc.data "
            + "            )DM "
            ...
            + "            join obs o on o.encounter_id=e.encounter_id "
            + "            join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "            where  e.encounter_type=6 and o.concept_id=165174 and o.value_coded in(23729) and grupo.concept_id=165323 "
            + "            and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256,1257) and  e.location_id =:location "
            + "            and p.voided=0 and e.voided=0 and o.voided=0 and grupo.voided=0 and obsEstado.voided=0 and e.encounter_datetime<:endRevisionDate "
            + "            )allConsultation ON allConsultation.patient_id = maxEnc.patient_id and allConsultation.encounter_datetime < maxEnc.data "
            + "            )DM "
            ...
            + "            join obs o on o.encounter_id=e.encounter_id "
            + "            join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "            where  e.encounter_type=6 and o.concept_id=165174 and o.value_coded in(165178,165179) and grupo.concept_id=165323 "
            + "            and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256,1257) and  e.location_id =:location "
            + "            and p.voided=0 and e.voided=0 and o.voided=0 and grupo.voided=0 and obsEstado.voided=0 and e.encounter_datetime<:endRevisionDate "
            + "            )allConsultation ON allConsultation.patient_id = maxEnc.patient_id and allConsultation.encounter_datetime < maxEnc.data "
            + "            )DM "
            ...
            + "            join obs o on o.encounter_id=e.encounter_id "
            + "            join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "            where  e.encounter_type=6 and o.concept_id=165174 and o.value_coded in(165315) and grupo.concept_id=165323 "
            + "            and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256,1257) and  e.location_id =:location "
            + "            and p.voided=0 and e.voided=0 and o.voided=0 and grupo.voided=0 and obsEstado.voided=0 and e.encounter_datetime<:endRevisionDate "
            + "            )allConsultation ON allConsultation.patient_id = maxEnc.patient_id and allConsultation.encounter_datetime < maxEnc.data "
            + "            )DM "
            ...
            + "            union "
            + " "
            + "            select maxEnc.patient_id,DM.data_mdc from "
            + "            ( "
            + "            select p.patient_id, max(e.encounter_datetime) data FROM patient p "
            + "            INNER JOIN encounter e on p.patient_id=e.patient_id "
            + "            where p.voided=0 and e.voided=0 and  e.encounter_type = 6 "
            ...
            + "            and o.concept_id=23739 and o.value_coded in(23720,23888) and o.voided=0 and o.location_id=:location "
            + "            group by p.patient_id "
            + "            ) max_tl "
            + "             )DM on DM.patient_id=maxEnc.patient_id and DM.data_mdc<maxEnc.data "
            + " "
            + " "
            + "             union "
            + " "
            + "             select maxEnc.patient_id,f.data_mdc from "
            + "            ( "
            + "            select p.patient_id, max(e.encounter_datetime) data FROM patient p "
            + "            INNER JOIN encounter e on p.patient_id=e.patient_id "
            + "            where p.voided=0 and e.voided=0 and  e.encounter_type = 6 "
            ...
            + "            ) f "
            + "            )f on f.patient_id=maxEnc.patient_id and f.data_mdc<maxEnc.data "
            + " "
            + "            union "
            + " "
            + "            select maxEnc.patient_id,f.data_mdc from "
    ...
    public static final String findPatientsWhoHasRegisteredAsIniciarInAtLeastOneMDS =
        "select maxEnc.patient_id from  (  "
            ...
            + "and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256) and  e.location_id=:location   "
            + "and p.voided=0 and e.voided=0 and o.voided=0 and grupo.voided=0 and obsEstado.voided=0 and e.encounter_datetime<:endRevisionDate  "
            + "union "
            + "select f.patient_id,f.data_mdc from (    "
            + "select max_tl.patient_id, max_tl.data_mdc from   (    "
            + "select p.patient_id,max(o.obs_datetime) data_mdc from patient p     "
            + "join encounter e on p.patient_id=e.patient_id      "
            + "join obs o on o.encounter_id=e.encounter_id     "
            + "where e.encounter_type=6 and e.voided=0 and o.voided=0 and p.voided=0  and e.location_id=:location and o.obs_datetime<=:endRevisionDate "
            + "and  o.concept_id=23739 and o.value_coded in(23720,23888) and o.voided=0 and o.location_id=:location "
            + "group by p.patient_id   "
            + ") max_tl     "
            + ")f "
            ...
            + "group by fila.patient_id   "
            + ") f "
            + ") final on final.patient_id=maxEnc.patient_id "
            + "where final.data_mdc=maxEnc.data ";
