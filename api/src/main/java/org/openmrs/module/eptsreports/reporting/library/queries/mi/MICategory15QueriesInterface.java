...
public interface MICategory15QueriesInterface {
  ...
  class QUERY {
    ...
    public static final String findPatientsWithTheLastCD4LessThan200OrEqualInClinicalConsultation =
        "select patient_id from "
            + "( "
            + "Select maxEnc.patient_id, Max(cd4.data_cd4), maxEnc.encounter_datetime from "
            + "( "
            + "Select p.patient_id,max(e.encounter_datetime) encounter_datetime from patient p "
            + "inner join encounter e on p.patient_id=e.patient_id "
            + "where p.voided=0 and e.voided=0 and e.encounter_type=6 and "
            ...
            + "inner join "
            + "( "
            + "Select p.patient_id, o.obs_datetime as data_cd4 "
            + "From patient p "
            + "inner join encounter e on p.patient_id=e.patient_id "
            + "inner join obs o on e.encounter_id=o.encounter_id "
            + "where p.voided=0 and e.voided=0 and o.voided=0 and concept_id = 1695 and  e.encounter_type = 6 and o.value_numeric<=200 and e.location_id=:location "
            + ")cd4 on cd4.patient_id = maxEnc.patient_id and cd4.data_cd4 < maxEnc.encounter_datetime "
    ...
    public static final String findPatientsWhoAreActiveOnArtAndInAtleastOneDSD =
        "select patient_id from( "
            + "select DM.patient_id, Max(DM.encounter_datetime) from ( "
            + "select maxEnc.patient_id, allConsultation.encounter_datetime from ( "
            + "select p.patient_id, max(e.encounter_datetime) data FROM patient p "
            + "INNER JOIN encounter e on p.patient_id=e.patient_id "
            + "where p.voided=0 and e.voided=0 and  e.encounter_type = 6 "
            + "and e.encounter_datetime  between :startInclusionDate and :endInclusionDate and e.location_id=:location "
            ...
            + "INNER JOIN encounter e on p.patient_id=e.patient_id "
            + "inner join obs o on e.encounter_id=o.encounter_id "
            + "where p.voided=0 and e.voided=0 and  e.encounter_type = 6 and o.concept_id in(23724) and  o.value_coded in (1256,1257) and o.voided = 0 and e.encounter_datetime<:endRevisionDate "
            + ")allConsultation ON allConsultation.patient_id = maxEnc.patient_id and allConsultation.encounter_datetime < maxEnc.data "
            + ")DM "
            ...
            + "INNER JOIN encounter e on p.patient_id=e.patient_id "
            + "inner join obs o on e.encounter_id=o.encounter_id "
            + "where p.voided=0 and e.voided=0 and  e.encounter_type = 6 and o.concept_id in(23730) and  o.value_coded in (1256,1257) and o.voided = 0 and e.encounter_datetime<:endRevisionDate "
            + ")allConsultation ON allConsultation.patient_id = maxEnc.patient_id and allConsultation.encounter_datetime < maxEnc.data "
            + ")DM "
            + "group by DM.patient_id "
            + "union "
            ...
            + "INNER JOIN encounter e on p.patient_id=e.patient_id "
            + "inner join obs o on e.encounter_id=o.encounter_id "
            + "where p.voided=0 and e.voided=0 and  e.encounter_type = 6 and o.concept_id in(23888) and  o.value_coded in (1256,1257) and o.voided = 0 and e.encounter_datetime<:endRevisionDate "
            + ")allConsultation ON allConsultation.patient_id = maxEnc.patient_id and allConsultation.encounter_datetime < maxEnc.data "
            + ")DM "
            + "group by DM.patient_id "
            + "union "
            ...
            + "INNER JOIN encounter e on p.patient_id=e.patient_id "
            + "inner join obs o on e.encounter_id=o.encounter_id "
            + "where p.voided=0 and e.voided=0 and  e.encounter_type = 6 and o.concept_id in(23729) and  o.value_coded in (1256,1257) and o.voided = 0 and e.encounter_datetime<:endRevisionDate "
            + ")allConsultation ON allConsultation.patient_id = maxEnc.patient_id and allConsultation.encounter_datetime < maxEnc.data "
            + ")DM "
            + "group by DM.patient_id "
            + "union "
            ...
            + "INNER JOIN encounter e on p.patient_id=e.patient_id "
            + "inner join obs o on e.encounter_id=o.encounter_id "
            + "where p.voided=0 and e.voided=0 and  e.encounter_type = 6 and o.concept_id in(23731) and  o.value_coded in (1256,1257) and o.voided = 0 and e.encounter_datetime<:endRevisionDate "
            + ")allConsultation ON allConsultation.patient_id = maxEnc.patient_id and allConsultation.encounter_datetime < maxEnc.data "
            + ")DM "
            + "group by DM.patient_id "
            + ") final ";
    ...
    public static final String findPatientsWhoHasRegisteredAsIniciarInAtLeastOneMDS =
        "select patient_id from ( "
            ...
            + "INNER JOIN encounter e on p.patient_id=e.patient_id "
            + "inner join obs o on e.encounter_id=o.encounter_id "
            + "where p.voided=0 and e.voided=0 and  e.encounter_type = 6 and o.concept_id in(23724,23730,23888,23729,23731) and o.value_coded=1256 and o.voided = 0 "
            + "and e.encounter_datetime<:endRevisionDate "
    ...
    public static final String findPatientsWhoHasRegisteredAsFimInAtLeastOneMDS =
        "select patient_id from ( "
            ...
            + "INNER JOIN encounter e on p.patient_id=e.patient_id "
            + "inner join obs o on e.encounter_id=o.encounter_id "
            + "where p.voided=0 and e.voided=0 and  e.encounter_type = 6 and o.concept_id in(23724,23730,23888,23729,23731) and o.value_coded=1267 and o.voided = 0 and e.encounter_datetime<:endRevisionDate "
            + ")dataMaximoModelo on dataMaximoModelo.patient_id=maxEnc.patient_id "
