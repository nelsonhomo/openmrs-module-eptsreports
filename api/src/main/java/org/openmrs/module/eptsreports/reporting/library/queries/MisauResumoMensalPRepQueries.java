  ...
  public class QUERY {
    ...
    public static final String findNumberOfUsersWhoseInitiatedPrepForTheFirstTime =
        "select inicio_prep.patient_id "
            ...
            + "		 	and o.obs_datetime <= :endDate and pp.program_id = 25 and pp.voided is false and e.location_id = :location "
            ...
            + "		 	and o.value_datetime <= :endDate and pp.program_id = 25 and pp.voided is false and e.location_id = :location "
            + "		 	group by p.patient_id "
            + "		) "
            ...
            + "where inicio_prep.data_inicio between :startDate and :endDate and entradas.patient_id is null ";
