...
public class TB7AdvancedDiseaseAndTBCohortQueries {
	...
	public CohortDefinition getNumberOfClientsEligibleForCD4CountRequestDuringInclusionPeriodIndicator1() {
		...
		final String mappings = "startDate=${endDate-10m+1d},endDate=${endDate-2m+1d},location=${location}"));

		definition.addSearch("TXNEW",
				EptsReportUtils.map(this.genericCohortQueries.generalSql("findPatientsWhoAreNewlyEnrolledOnART",
						TxNewQueries.QUERY.findPatientsWhoAreNewlyEnrolledOnART), mappings));

		definition.addSearch("PREGNANT", Mapped.mapStraightThrough(this.getPatientsWhoArePregnant()));
						mappings));

		definition.addSearch("HIGHVIRALLOAD", EptsReportUtils
				.map(this.genericCohortQueries.generalSql("HIGHVIRALLOAD", findPatientWithHighViralLoad()), mappings));

		definition.addSearch("REINITIATEDART", EptsReportUtils
				.map(this.genericCohortQueries.generalSql("REINITIATEDART", findPatientWhoReinitiatedART()), mappings));

		definition.addSearch("TROUT" + "", EptsReportUtils
				.map(this.genericCohortQueries.generalSql("TROUT", findPatientWhoAreTransferedOut()), mappings));

		definition.addSearch("DEAD" + "",
				EptsReportUtils.map(this.genericCohortQueries.generalSql("DEAD", findPatientWhoAreDead()), mappings));

		definition.setCompositionString("(TXNEW OR PREGNANT OR HIGHVIRALLOAD OR REINITIATEDART) NOT (TROUT OR DEAD)");
	...
	public CohortDefinition getNumberOfClientsWithCd4ResultDuringInclusionPeriodIndicator2() {
		...
		definition.addSearch("ELEGIBLE",
				map(this.getNumberOfClientsEligibleForCD4CountRequestDuringInclusionPeriodIndicator1(), mappingsDen));

		definition.addSearch("CD4RESULT", EptsReportUtils
				.map(this.genericCohortQueries.generalSql("CD4RESULT", findPatientWhoHaveCd4Result()), mappings));
	...
	public CohortDefinition getNumberOfClientsWithCd4ResultDuringInclusionPeriodIndicator3() {
		...
		definition.addSearch("ELEGIBLE2",
				map(this.getNumberOfClientsWithCd4ResultDuringInclusionPeriodIndicator2(), mappingsDen));

		definition.addSearch("CD4RESULT", EptsReportUtils
				.map(this.genericCohortQueries.generalSql("CD4RESULT", findPatientWhoHaveCd4Result2()), mappings));

		definition.setCompositionString("ELEGIBLE2 AND CD4RESULT");
		return definition;
	}

	public CohortDefinition getNumberOfClientsWithCd4ResultDuringInclusionPeriodIndicator3WithTBLam() {
		...
		definition.addSearch("ELEGIBLE3",
				map(this.getNumberOfClientsWithCd4ResultDuringInclusionPeriodIndicator3(), mappingsDen));

		definition.addSearch("TBLAM",
				EptsReportUtils.map(
						this.genericCohortQueries.generalSql("TBLAM", findPatientWhoHaveTbLamResulUntilCurrentDate()),
						mappings));
	...
	public CohortDefinition getNumberOfClientsWithCd4ResultDuringInclusionPeriodIndicator3WithoutTBLam() {
	...
	public CohortDefinition getNumberOfClientsWithoutCd4ResultDuringInclusionPeriodIndicator3() {
		...
		definition.addSearch("CD4RESULT", EptsReportUtils
				.map(this.genericCohortQueries.generalSql("CD4RESULT", findPatientWhoHaveCd4Result3()), mappings));

		definition.setCompositionString("ELEGIBLE2 AND CD4RESULT");
		return definition;
	}

	public CohortDefinition getumberOfClientsWithCD4CountDuringInclusionPeriodWithoutSevereImmunodepression() {
		...
		definition.addSearch("WITHTBLAM",
				map(this.getNumberOfClientsWithoutCd4ResultDuringInclusionPeriodIndicator3WithTBLam(), mappings));

		definition.addSearch("WITHOUTTBLAM",
				map(this.getNumberOfClientsWithoutCd4ResultDuringInclusionPeriodIndicator3WithoutTBLam(), mappings));

		definition.setCompositionString("WITHTBLAM OR WITHOUTTBLAM");
		return definition;
	}

	public CohortDefinition getNumberOfClientsWithoutCd4ResultDuringInclusionPeriodIndicator3WithTBLam() {
	...
	public CohortDefinition getNumberOfClientsWithoutCd4ResultDuringInclusionPeriodIndicator3WithoutTBLam() {
	...
	public CohortDefinition getNumberOfClientsWithoutCD4CountButWithTBLAMResultsDuringTheInclusionPeriodIncludingClientsWhoWereNotEligibleForCD4() {
		...
		definition.addSearch("TBLAM" + "", EptsReportUtils
				.map(this.genericCohortQueries.generalSql("TBLAM", findPatientWhoHaveTbLamResul1()), mappings));

		definition.addSearch("CD4" + "", EptsReportUtils
				.map(this.genericCohortQueries.generalSql("CD4", findPatientWhoHaveCd4Result()), mappings));
	...
	public CohortDefinition getNumberOfClientsWithPositiveTBLAMResultsByReportGenerationDate() {
		...
		definition.addSearch("TBLAM",
				map(this.getNumberOfClientsWithTBLAMResultsByReportGenerationDate(), mappingsDen));

		definition.addSearch("POSITIVE",
				EptsReportUtils.map(
						this.genericCohortQueries.generalSql("POSITIVE",
	...
	public CohortDefinition getNumberOfClientsWithNegativeTBLAMResultsByReportGenerationDate() {
		...
		definition.addSearch("NEGATIVE",
				EptsReportUtils.map(
						this.genericCohortQueries.generalSql("NEGATIVE",
	...
	public CohortDefinition getNumberOfClientsWithPositiveTBLAMResultsByReportGenerationDate(
		...
		definition.addSearch("TBLAMPOSITIVE",
				map(this.getNumberOfClientsWithPositiveTBLAMResultsByReportGenerationDate(), mappingsDen));

		definition.addSearch("GRADE", EptsReportUtils.map(
				this.genericCohortQueries.generalSql("GRADE", findLevelOfPosotivity(levelOfPositivity)), mappings));
	...
	public CohortDefinition getClientsWithoutPositiveTBLAMButNotTestedWithGeneXpert() {
		...
		definition.addSearch("GENEXPERT", EptsReportUtils
				.map(this.genericCohortQueries.generalSql("GENEXPERT", findPatientWhoHaveGenexpert()), mappings));
	...
	public CohortDefinition getClientsWithPositiveTBLAMAndGeneXpertPositiveforTB() {
		...
		definition.addSearch("GENEXPERTPOSITIVE", EptsReportUtils.map(
				this.genericCohortQueries.generalSql("GENEXPERTPOSITIVE", findPatientWhoHavePositiveGenexpert()),
				mappings));
	...
	public CohortDefinition getClientsWithPositiveTBLAMButNotTestedWithGeneXpertForTB() {
		...
		definition.addSearch("TBLAMNOTGENEXPERT",
				map(this.getClientsWithPositiveTBLAMButNotTestedWithGeneXpert(), mappingsDen));

		definition.addSearch("TB", EptsReportUtils
				.map(this.genericCohortQueries.generalSql("TB", findPatientWhoHavePositiveGenexpertTb()), mappings));
	...
	public CohortDefinition getClientsWithPositiveTBLAMButNotTestedWithGeneXpertForTBGradeDesagregation(
			LevelOfPositivity levelOfPositivity) {
		...
		definition.addSearch("DENOMINATOR",
	...
	public CohortDefinition getPatientsWhoArePregnant() {
		...
		definition.addSearch("PREGNANT",
				EptsReportUtils.map(
						this.genericCohortQueries.generalSql("PREGNANT", findPregnantOrBreatfeeding(TypePTV.PREGNANT)),
						"startDate=${endDate-10m+1d},endDate=${endDate-1m},location=${location}"));

		definition.addSearch("CD4", EptsReportUtils.map(this.genericCohortQueries.generalSql("CD4",
