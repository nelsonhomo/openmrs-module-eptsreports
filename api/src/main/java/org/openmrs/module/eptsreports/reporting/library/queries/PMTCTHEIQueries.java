  ...
  class QUERY {
    ...
    public static final String
        findNumberOfInfantesWhoHadVirologicHIVTesResulttBy12MonthsOfAgeDuringReportingPeriod =
            "																				   "
                ...
                + "    inner join(                                                                                                                                                                         "
                + "                                                                                                                                                                                        "
                + "      select p.patient_id, data_colheita_amostra.value_datetime data_colheita                                                                                                           "
                + "      from patient p                                                                                                                                                                    "
                + "           inner join encounter e on e.patient_id = p.patient_id                                                                                                                        "
                ...
                + "       where p.voided = 0 and  e.voided = 0 and hiv_dna_pcr.voided = 0 and data_colheita_amostra.voided = 0  and diagnostico_precoce_infantil.voided = 0  and e.encounter_type = 13 and e.location_id = :location "
                ...
                + "           and hiv_dna_pcr.concept_id = 1030 and hiv_dna_pcr.value_coded in (703,664)  and e.encounter_datetime between :startDate and :endDate  and data_colheita_amostra.concept_id = 23821 "
                + "                                                                                                                                                                                        "
                + "    ) ccr_colheita_amostra on ccr_colheita_amostra.patient_id = ccr_admissao.patient_id                                                                                                 "
                + ")ccr_colheita_amostra                                                                                                                                                                   "
                + "inner join                                                                                                                                                                              "
                + "person pe on ccr_colheita_amostra.patient_id = pe.person_id                                                                                                                             "
                + "where pe.voided = 0 and ( pe.birthdate is not null and timestampdiff(day,pe.birthdate,ccr_colheita_amostra.data_colheita) <= 365)                                                       ";
    ...
    public static final String getPMTCTPatienstByAge =
        "																																			  "
            ...
            + "        and diagnostico_precoce_infantil.concept_id = 165502 and diagnostico_precoce_infantil.value_coded in (165503, 165506, 165507, 165510 )                                         "
            + "        and data_colheita_amostra.concept_id = 23821 and data_colheita_amostra.value_datetime <= :endDate                                                                              "
            + "                                                                                                                                                                                       "
            + ") ccr_colheita                                                                                                                                                                         "
            + "inner join                                                                                                                                                                             "
            + "person pe on pe.person_id = ccr_colheita.patient_id                                                                                                                                    "
            + "where pe.voided = 0 and ( pe.birthdate is not null and timestampdiff(%s, pe.birthdate, ccr_colheita.data_colheita) %s )					                                              ";
    ...
    public static final String findPatientsTestResultsByResultValue =
        "																																   						  "
            ...
            + "        inner join obs data_colheita_amostra on data_colheita_amostra.encounter_id = e.encounter_id                                                                                                            "
            + "        inner join obs hiv_dna_pcr on hiv_dna_pcr.encounter_id = e.encounter_id                                                                                                                                "
            + "    where p.voided = 0 and  e.voided = 0 and hiv_dna_pcr.voided = 0 and data_colheita_amostra.voided = 0  and e.encounter_type = 13 and e.location_id = :location "
            + "        and hiv_dna_pcr.concept_id = 1030 and hiv_dna_pcr.value_coded = %s  and e.encounter_datetime between :startDate and :endDate  and data_colheita_amostra.concept_id = 23821                             "
            + ")ccr_colheita_amostra                                                                                                                                                                                          "
            + "inner join                                                                                                                                                                                                     "
            + "person pe on ccr_colheita_amostra.patient_id = pe.person_id                                                                                                                                                    "
            + "where pe.voided = 0 and ( pe.birthdate is not null and timestampdiff(day,pe.birthdate,ccr_colheita_amostra.data_colheita) <= 365)                                                                              ";
