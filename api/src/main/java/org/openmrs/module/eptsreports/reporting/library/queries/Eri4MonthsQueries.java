  ...
  public static final String
    ...
    String query =
        "SELECT patient_id FROM (SELECT inicio_real.patient_id, "
            ...
            + "              		where pp.program_id = 2 and ps.state = 7 and pp.voided = 0 and ps.voided = 0 and pp.location_id = 398 "
            + " "
            + "              		union "
            + " "
            ...
            + "                               and e.encounter_type = 21 and  e.location_id= 398 "
            + "                               group by p.patient_id "
            + "                       ) ultimaBusca "
            + "                           inner join encounter e on e.patient_id = ultimaBusca.patient_id "
            + "                           inner join obs o on o.encounter_id = e.encounter_id "
            + "                      where e.encounter_type = 21 and o.voided=0 and o.concept_id=2016 and o.value_coded in (1706,23863) and ultimaBusca.data_estado = e.encounter_datetime and e.location_id = 398 "
