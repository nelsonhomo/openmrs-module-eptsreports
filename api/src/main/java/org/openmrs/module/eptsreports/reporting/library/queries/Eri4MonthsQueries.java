  ...
  public static final String
    ...
    String query =
        "SELECT patient_id FROM (SELECT inicio_real.patient_id, "
            ...
            + "INNER JOIN patient_program pg ON p.patient_id=pg.patient_id "
            + "inner join patient_state ps on pg.patient_program_id=ps.patient_program_id "
            + "WHERE pg.voided=0 and ps.voided=0 and p.voided=0 AND pg.program_id=2 AND ps.state in (8,10) AND ps.end_date is null AND ps.start_date between  (:endDate - INTERVAL 5 MONTH  + INTERVAL 1 DAY) and :endDate and location_id=:location "
            + "group by pg.patient_id "
            + "UNION "
            ...
            + "o.concept_id in (6272,6273) and o.value_coded in (1366,1709) AND o.obs_datetime between  (:endDate - INTERVAL 5 MONTH  + INTERVAL 1 DAY) and :endDate and e.location_id=:location "
            + "GROUP BY p.patient_id  "
            + ")saidas   "
            + "inner join  "
            + "(  "
            ...
            + "inner join patient_state ps on pg.patient_program_id=ps.patient_program_id   "
            + "where pg.voided=0 and ps.voided=0 and p.voided=0 and   "
            + "pg.program_id=2 and ps.start_date between (:endDate - INTERVAL 5 MONTH  + INTERVAL 1 DAY) and :endDate   "
            ...
            + "inner join encounter e on p.patient_id=e.patient_id   "
            + "inner join obs o on o.encounter_id=e.encounter_id   "
            + "where e.voided=0 and p.voided=0 and pe.voided = 0 and e.encounter_datetime between (:endDate - INTERVAL 5 MONTH  + INTERVAL 1 DAY) and :endDate  "
            ...
            + "inner join encounter e on p.patient_id=e.patient_id   "
            + "inner join obs o on o.encounter_id=e.encounter_id  "
            + "where e.voided=0 and p.voided=0 and o.obs_datetime between (:endDate - INTERVAL 5 MONTH  + INTERVAL 1 DAY) and :endDate and o.voided=0 and o.concept_id=6272 and o.value_coded=1706 and e.encounter_type=53   "
            + "and  e.location_id=:location   "
            + "group by p.patient_id   "
            + "union  "
            + "select p.patient_id,max(e.encounter_datetime) data_transferidopara from  patient p   "
            + "inner join encounter e on p.patient_id=e.patient_id   "
            + "inner join obs o on o.encounter_id=e.encounter_id where  e.voided=0 and p.voided=0 and e.encounter_datetime between (:endDate - INTERVAL 5 MONTH  + INTERVAL 1 DAY) and :endDate and   "
            ...
            + ")final where final.data_transferidopara between (:endDate - INTERVAL 5 MONTH  + INTERVAL 1 DAY) and :endDate  "
            ...
            + "and transferidopara.data_estado between (:endDate - INTERVAL 5 MONTH  + INTERVAL 1 DAY) and :endDate  "
            + ") allSaida "
            + ") allSaida "
            + "group by patient_id "
