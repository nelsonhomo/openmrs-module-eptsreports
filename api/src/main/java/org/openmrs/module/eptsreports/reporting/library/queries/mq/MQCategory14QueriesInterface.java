  ...
  class QUERY {
    ...
    public static final String findPatientsWhoAreActiveOnArtAndInAtleastOneDSDWithViralSupression =
        "            select patient_id from ( "
            ...
            + "		where enc.encounter_datetime >= (date(carga_viral.data_carga) - INTERVAL 12 MONTH) and enc.encounter_datetime < date(carga_viral.data_carga) "
            ...
            + "	where td.data_mdc>= (date(carga_viral.data_carga) - INTERVAL 12 MONTH) and td.data_mdc < date(carga_viral.data_carga) "
            + "	group by carga_viral.patient_id "
            + "	) tipodispensa "
