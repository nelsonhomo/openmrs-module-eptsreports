    ...
    public static final String
      ...
      String query =
          "select inicio_real.patient_id from (select patient_id,min(data_inicio) data_inicio from ("
              ...
              + "e.encounter_type in (%s) and  o.concept_id in (856,1305) and o.obs_datetime > '0000-00-00 00:00' and  o.obs_datetime between date_add(date_add(:endDate, interval -12 MONTH), interval 1 day) and :endDate and e.location_id=:location group by p.patient_id) carga_viral on inicio_real.patient_id=carga_viral.patient_id "
    ...
    public static final String
      ...
      String query =
          "select inicio_real.patient_id from( "
              ...
              + "inner join encounter e on p.patient_id=e.patient_id "
              + "inner join obs o on e.encounter_id=o.encounter_id "
              + "where p.voided=0 and e.voided=0 and o.voided=0 and e.encounter_type in (%s) and  o.concept_id in (856,1305) and o.obs_datetime > '0000-00-00 00:00' and  o.obs_datetime between date_add(date_add(:endDate, interval -12 MONTH), interval 1 day) and :endDate and e.location_id=:location group by p.patient_id) carga_viral on inicio_real.patient_id=carga_viral.patient_id "
    ...
    public static final String
      ...
      String query =
          "select inicio_real.patient_id  from ( "
              ...
              + "inner join encounter e on p.patient_id=e.patient_id "
              + "inner join obs o on e.encounter_id=o.encounter_id "
              + "where p.voided=0 and e.voided=0 and o.voided=0 and e.encounter_type in (%s) and  o.concept_id in (856,1305) and o.obs_datetime > '0000-00-00 00:00' and  o.obs_datetime between date_add(date_add(:endDate, interval -12 MONTH), interval 1 day) and :endDate and e.location_id=:location group by p.patient_id) ultima_carga "
