  ...
  class QUERY {
    ...
    public static String getEc5Total =
        "SELECT   "
            ...
            + "where p.voided=0 and e.voided=0 and e.encounter_type=52 and date(e.encounter_datetime)>='2019-11-01' and date(e.encounter_datetime)<=curdate() and e.location_id in (:location)  "
            + ")primeira "
            + "inner join "
            + "( "
