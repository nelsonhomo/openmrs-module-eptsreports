  ...
  class QUERY {
    ...
    public static final String findChildrenAndAdolescentsWithFullDisclore =
        "SELECT tx_new.patient_id FROM (    "
            ...
            + "where  (tx_new.art_start_date BETWEEN DATE_ADD(DATE_SUB(:endRevisionDate, INTERVAL 14 MONTH), INTERVAL 1 DAY) and DATE_SUB(:endRevisionDate, INTERVAL 11 MONTH)) "
            + "and    (revelado.dataRevelacaoTotal BETWEEN revelado.dataRevelacaoTotal and DATE_ADD(revelado.dataRevelacaoTotal, INTERVAL 12 MONTH)) ";
  }
}
