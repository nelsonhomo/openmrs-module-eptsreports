...
@Component
public class PrepCtTransferredInBeforeReportStartDateProcessor {

  public Map<Integer, Date> getPatientsTransferredInBeforeReporStartDate(
    ...
    SqlQueryBuilder qb =
        new SqlQueryBuilder(
            " select patient_id, min(data_estado) data_transferencia from( "
                ...
                + "and e.encounter_datetime < :startDate and e.location_id=:location group by p.patient_id) result group by patient_id ",
