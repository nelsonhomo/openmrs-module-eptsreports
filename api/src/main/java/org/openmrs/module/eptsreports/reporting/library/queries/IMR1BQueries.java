    ...
    public static final String
        findPatientsNewlyEnrolledOnArtTreatmentAndInitiatedArtTreatmentAMonthPriorToTheReporingPeriod =
            "select patient_id from (	"
                ...
                + "	where inicio_tarv.art_start_date >= inscricao_tarv.art_enrolled_date and (TIMESTAMPDIFF(DAY,inscricao_tarv.art_enrolled_date , inicio_tarv.art_start_date)) <= 15 ) result_";
    ...
    public static final String
        findPatientsNewlyEnrolledOnArtTreatmentAndInitiatedArtTreatmentWithEnrollmentDateGreatherThanArtStartDateAMonthPriorToTheReporingPeriod =
            "select patient_id from (	"
                ...
                + "	where art_enrolled_date between (:endDate - INTERVAL 2 MONTH  + INTERVAL 1 DAY) and (:endDate - INTERVAL 1 MONTH )	"
                + "	) inscricao_tarv on inicio_tarv.patient_id = inscricao_tarv.patient_id	"
                + "	where inscricao_tarv.art_enrolled_date > inicio_tarv.art_start_date ) result_";
  }
}
