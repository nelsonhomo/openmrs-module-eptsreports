...
@Component
public class PrepCtReturnedFollowUpVisitProcessor {

  public Map<Integer, Date> getPatientsReturnedFollowUpVisit(EvaluationContext context) {

    SqlQueryBuilder qb =
        new SqlQueryBuilder(
            "select "
                + "p.patient_id,e.encounter_datetime data_consulta "
                + "from patient p "
