  ...
  class QUERY {
    ...
    public static String findPatiendsWithIncompatibleMDSInFichaClinica =
        "    						select distinct patient.patient_id, "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded in (23730, 23724, 165178, 165179, 165317, 165318, 165320, 165321, 165315, 165314) and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded in (23730, 23888, 165178, 165179, 165264, 165265, 165317, 165320, 165321, 165315, 165314) and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded in (23888, 23724, 165179, 165264, 165265, 165320, 165315, 165314, 165318) and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded in (23888, 23724, 165178, 165264, 165265, 165317, 165320, 165321, 165315, 165314, 165318) and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded in (23724, 165178, 165179, 165265, 165176, 165318, 165319, 165315, 165314) and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded in (23724, 165178, 165179, 165318, 165319, 165321, 165315, 165314) and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded in (23730, 23888, 23724, 165179, 165318, 165319, 165320, 165315, 165314) and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded in (23888, 165178, 165179, 165264, 165265, 165317, 165319, 165320, 165314) and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded = 165319 and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            + "					 ) saaj "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded in (165264, 165265, 165317, 165318, 165320) and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded in (23730, 23888, 23724, 165178, 165179, 165317, 165318, 165319, 165315, 165314) and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded = 165321 and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            + "					 ) dah "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded in (23730, 23888, 23724, 165179, 165315, 165314) and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded in (23888, 23724, 165179, 165264, 165265, 165317, 165320, 165321, 165314, 165178) and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded in (23730, 23888, 23724, 165178, 165179, 165264, 165265, 165317, 165318, 165320, 165321, 165315) and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
