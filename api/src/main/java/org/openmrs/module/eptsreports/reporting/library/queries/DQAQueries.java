  ...
  public class QUERY {
    ...
    public static final String findPatientsWhoAreCurrentlyEnrolledOnART =
        "	select patient_id "
            ...
            + "			where pp.program_id = 2 and ps.state in (7,8,10) and pp.voided = 0 and ps.voided = 0 and pp.location_id = 400 "
            + "			union "
            + "			select 	p.patient_id, "
            ...
            + "			group by p.patient_id "
            + "			union "
            + "			SELECT lastHomeVisitCard.patient_id, lastHomeVisitCard.data_estado FROM ( "
            ...
            + "			o.voided=0 and e.encounter_type in (21,36,37) and  e.location_id=:location "
            + "			group by p.patient_id "
            + "			) lastHomeVisitCard "
            + "			inner join encounter e on e.patient_id = lastHomeVisitCard.patient_id "
            + "			inner join obs o on e.encounter_id = o.encounter_id "
            + "			where e.voided = 0 and o.voided = 0 and o.concept_id=2016 and o.value_coded in (1706,23863)  and e.encounter_type in (21,36,37) and e.encounter_datetime = lastHomeVisitCard.data_estado "
            + "		) allSaida "
            + "	group by patient_id "
