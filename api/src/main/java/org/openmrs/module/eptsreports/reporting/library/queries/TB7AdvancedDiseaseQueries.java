...
public interface TB7AdvancedDiseaseQueries {
  ...
  public class QUERY {
    ...
    // e.encounter_type in (18,6,9)  			"
    //                + "              and o.concept_id=1255 and o.value_coded=1256 and
    ...
    // in (18,6,9,53) 				"
    //                + "               and o.concept_id=1190 and o.value_datetime is not null and
    ...
    //                + "            union  																					"
    //                + "             																							"
    //                + "            select e.patient_id, min(e.encounter_datetime) as
    // art_start_date  						"
    //                + "            from patient p  																			"
    //                + "              inner join encounter e on p.patient_id=e.patient_id
    //	"
    ...
    // e.encounter_type=52 						"
    //                + "              and o.concept_id=23866 and o.value_datetime is not null and
    // o.value_datetime <= :endDate and e.location_id= :location  "
    //                + "                group by p.patient_id  																"
    //                + "      ) art_start  																					"
    //                + "               group by patient_id  																	"
    ...
    //                + "    inner join encounter e on e.patient_id=p.patient_id 												"
    //                + "    inner join obs o on o.encounter_id=e.encounter_id 												"
    //                + "  where e.voided=0 and e.encounter_type in (6,13,53,51,90) and o.concept_id
    // in (1695, 165515) and o.voided=0  "
    //                + "    and  e.location_id= :location and o.obs_datetime <= date_add(:endDate,
    // interval  33 day) 			"
    //                + ")cd4_absolute on cd4_eligible.patient_id = cd4_absolute.patient_id
    //	"
    //                + " where  cd4_absolute.obs_datetime between cd4_eligible.art_start_date and
    // date_add(cd4_eligible.art_start_date, interval 33 day)";
