...
public interface TB7AdvancedDiseaseQueries {
	...
	public class QUERY {
		...
		public static final String FIND_PREGNANTS_WITH_COUNT_CD4 = "TB7/PATIENTS_PREGNANT_WITH_COUNT_CD4.sql";

		public static final String FIND_PATIENTS_WITH_SEVERE_IMMUNOSUPPRESSION_TX_NEW = "TB7/PATIENTS_WITH_SEVERE_IMMUNOSUPPRESSION_TX_NEW.sql";

		public static final String FIND_PATIENTS_WITH_SEVERE_IMMUNOSUPPRESSION_HIGH_VL = "TB7/PATIENTS_WITH_SEVERE_IMMUNOSUPPRESSION_HIGH_VL.sql";

		public static final String FIND_PATIENTS_WITH_SEVERE_IMMUNOSUPPRESSION_ART_RESTART = "TB7/PATIENTS_WITH_SEVERE_IMMUNOSUPPRESSION_ART_RESTART.sql";

		public static final String FIND_PATIENTS_WITH_SEVERE_IMMUNOSUPPRESSION_PREGNANT = "TB7/PATIENTS_WITH_SEVERE_IMMUNOSUPPRESSION_PREGNANT.sql";

		public static final String FIND_PATIENTS_WITH_SEVERE_IMMUNOSUPPRESSION_WITH_TBLAM_GRADE_LEVEL = "TB7/PATIENTS_WITH_SEVERE_IMMUNOSUPPRESSION_WITH_GRADE_LEVEL.sql";
		...
		public static String findPatientsWithHighViralLoad = "select distinct ultima_cv.patient_id 													"
				+ "from( 																															"
				+ "																																	"
		...
		public static String findPatientWhoReinitiatedART = "select patient_id 																		"
				+ "from (																 															"
		...
		public static final String findPatientsWhoInitiatedARTAndHaveCD4CountWithin33Days = " select cd4_eligible.patient_id  		"
				+ "from( 																								"
				+ " 																										"
		...
		public static final String findPatientsWIthHighVLWithCD4Count = "select cd4_eligible.patient_id  												"
				+ "from ( 																																"
