...
public class EptsGeneralIndicator extends BaseIndicators {
  ...
  public Indicator getIndicator(String name, SqlEncounterQuery sql) {

    QueryCountIndicator query = new QueryCountIndicator();
    ...
    query.setQuery(Mapped.mapStraightThrough(sql));
    return query;
  }
}
