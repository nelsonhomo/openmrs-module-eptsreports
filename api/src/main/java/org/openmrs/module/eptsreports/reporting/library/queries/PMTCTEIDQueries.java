...
public interface PMTCTEIDQueries {
  ...
  class QUERY {
    ...
    public static final String
        findNumberOfInfantesWhoHadVirologicHIVTestBy12MonthsOfAgeDuringReportingPeriod =
            "																							"
                ...
                + "    from (                                                                                                                                                                             "
                + "                                                                                                                                                                                       "
                + "        select p.patient_id, pg.date_enrolled data_admissao                                                                                                                            "
                + "            from patient p                                                                                                                                                             "
                ...
                + "where pe.voided = 0 and ( pe.birthdate is not null and timestampdiff(month,pe.birthdate,ccr_colheita_amostra.data_colheita) < 12 )                                                     ";
    ...
    public static final String findFirstVRRestulTest =
        "             																																  "
            + "select patient_id                                                                                                                                                                      "
            + "from(                                                                                                                                                                                  "
            + "    select p.patient_id, data_colheita_amostra.value_datetime data_colheita                                                                                                            "
            ...
            + "         inner join obs diagnostico_precoce_infantil on diagnostico_precoce_infantil.encounter_id = e.encounter_id                                                                     "
            + "    where p.voided = 0 and  e.voided = 0 and data_colheita_amostra.voided = 0  and diagnostico_precoce_infantil.voided = 0 and e.encounter_type = 13 and e.location_id = :location     "
            + "        and diagnostico_precoce_infantil.concept_id = 165502 and diagnostico_precoce_infantil.value_coded in (165503, 165507 )                                                         "
            + "        and data_colheita_amostra.concept_id = 23821 and data_colheita_amostra.value_datetime <= :endDate                                                                              "
            + "                                                                                                                                                                                       "
            + ") ccr_colheita                                                                                                                                                                         "
            + "inner join                                                                                                                                                                             "
            + "person pe on pe.person_id = ccr_colheita.patient_id                                                                                                                                    "
            + "where pe.voided = 0 and ( pe.birthdate is not null and timestampdiff(month,pe.birthdate,ccr_colheita.data_colheita) <= 12)                                                             ";

    public static final String findSecondVRRestulTest =
        "             																																  "
            + "select patient_id                                                                                                                                                                      "
            + "from(                                                                                                                                                                                  "
            + "    select p.patient_id, data_colheita_amostra.value_datetime data_colheita                                                                                                            "
            ...
            + "         inner join obs diagnostico_precoce_infantil on diagnostico_precoce_infantil.encounter_id = e.encounter_id                                                                     "
            + "    where p.voided = 0 and  e.voided = 0 and data_colheita_amostra.voided = 0  and diagnostico_precoce_infantil.voided = 0 and e.encounter_type = 13 and e.location_id = :location     "
            + "        and diagnostico_precoce_infantil.concept_id = 165502 and diagnostico_precoce_infantil.value_coded in (165506, 165510 )                                                         "
            + "        and data_colheita_amostra.concept_id = 23821 and data_colheita_amostra.value_datetime <= :endDate                                                                              "
            + "                                                                                                                                                                                       "
            + ") ccr_colheita                                                                                                                                                                         "
            + "inner join                                                                                                                                                                             "
