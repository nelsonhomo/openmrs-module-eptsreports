...
@Component
public class Indicator2DataSetDefinition extends BaseDataSet {
  ...
  public DataSetDefinition constructDataset() {
    ...
    dataSetDefinition.setName("Indicator 2");
    ...
    CohortDefinition indicator2 = this.resumoMensalCETACohortQueries.getPatientsIndicator2();

    dataSetDefinition.addDimension(
        "indicator2Dimension",
        EptsReportUtils.map(
            this.resumoMensalCETADimensions.getResumoMensalCETADimension(indicator2), mappings));

    final CohortIndicator rmCETAIndicator2 =
        this.eptsGeneralIndicator.getIndicator("RMCETA", EptsReportUtils.map(indicator2, mappings));

    addRow(
        dataSetDefinition,
        "I2",
        "Nr de Pacientes com resultado Positivo no FICA BEM",
        EptsReportUtils.map(rmCETAIndicator2, mappings),
        resumoMensalCETADataSetDefinition.getColumns("indicator2Dimension"));
