...
public class TB7AdvancedDiseaseAndTBDataSet extends BaseDataSet {
	...
	@Autowired
	private TB7AdvancedDiseaseAndTBCohortQueries tb7AdvancedDiseaseAndTBCohortQueries;
	@Autowired
	...
	@Autowired
	private TB7CascadeReportDimensions tb7CascadeReportDimensions;
	...
	public DataSetDefinition constructDataset() {
		...
		dataSetDefinition.addDimension("cascadeOneIndicatorOneDimension",
				EptsReportUtils.map(this.tb7CascadeReportDimensions.getCascadeOneIndicatorOneDimension(), mappings));

		dataSetDefinition.addDimension("cascadeOneIndicatorTwoDimension",
				EptsReportUtils.map(this.tb7CascadeReportDimensions.getCascadeOneIndicatorTwoDimension(), mappings));
		...
		final CohortDefinition tb7CohortIndicator = this.tb7AdvancedDiseaseAndTBCohortQueries
				.getNumberOfClientsEligibleForCD4CountRequestDuringInclusionPeriodIndicator1();

		final CohortDefinition tb7CohortIndicator2 = this.tb7AdvancedDiseaseAndTBCohortQueries
				.getNumberOfClientsWithCd4ResultDuringInclusionPeriodIndicator2();

		final CohortDefinition tb7CohortIndicator3 = this.tb7AdvancedDiseaseAndTBCohortQueries
				.getNumberOfClientsWithCd4ResultDuringInclusionPeriodIndicator3();

		final CohortDefinition tb7CohortIndicator3TbLam = this.tb7AdvancedDiseaseAndTBCohortQueries
				.getNumberOfClientsWithCd4ResultDuringInclusionPeriodIndicator3WithTBLam();

		final CohortDefinition tb7CohortIndicator3WithoutTbLam = this.tb7AdvancedDiseaseAndTBCohortQueries
				.getNumberOfClientsWithCd4ResultDuringInclusionPeriodIndicator3WithoutTBLam();

		final CohortDefinition tb7CohortIndicator3WithoutCd4WithTbLam = this.tb7AdvancedDiseaseAndTBCohortQueries
				.getumberOfClientsWithCD4CountDuringInclusionPeriodWithoutSevereImmunodepression();

		final CohortDefinition tb7CohortIndicator3WithoutCd4WithTbLamTotal = this.tb7AdvancedDiseaseAndTBCohortQueries
				.getNumberOfClientsWithoutCd4ResultDuringInclusionPeriodIndicator3WithTBLam();

		final CohortDefinition tb7CohortIndicator3WithoutCd4WithoutTbLamTotal = this.tb7AdvancedDiseaseAndTBCohortQueries
		...
		final CohortIndicator tb7Indicator1 = this.eptsGeneralIndicator.getIndicator("TB7",
				EptsReportUtils.map(tb7CohortIndicator, mappings));

		final CohortIndicator tb7Indicator2 = this.eptsGeneralIndicator.getIndicator("TB7",
				EptsReportUtils.map(tb7CohortIndicator2, mappings));

		final CohortIndicator tb7Indicator3 = this.eptsGeneralIndicator.getIndicator("TB7",
				EptsReportUtils.map(tb7CohortIndicator3, mappings));

		final CohortIndicator tb7Indicator3TbLam = this.eptsGeneralIndicator.getIndicator("TB7",
				EptsReportUtils.map(tb7CohortIndicator3TbLam, mappings));

		final CohortIndicator tb7Indicator3WithoutTbLam = this.eptsGeneralIndicator.getIndicator("TB7",
				EptsReportUtils.map(tb7CohortIndicator3WithoutTbLam, mappings));

		final CohortIndicator tb7Indicator3WithoutCd4WithTbLam = this.eptsGeneralIndicator.getIndicator("TB7",
				EptsReportUtils.map(tb7CohortIndicator3WithoutCd4WithTbLam, mappings));

		final CohortIndicator tb7Indicator3WithoutCd4WithTbLamTotal = this.eptsGeneralIndicator.getIndicator("TB7",
				EptsReportUtils.map(tb7CohortIndicator3WithoutCd4WithTbLamTotal, mappings));

		final CohortIndicator tb7Indicator3WithoutCd4WithoutTbLamTotal = this.eptsGeneralIndicator.getIndicator("TB7",
				EptsReportUtils.map(tb7CohortIndicator3WithoutCd4WithoutTbLamTotal, mappings));

//		final CohortIndicator tb7IndicatorpatienWithoutCD4CountButWithTBLAMResults = this.eptsGeneralIndicator
//				.getIndicator("TB7", EptsReportUtils.map(patienWithoutCD4CountButWithTBLAMResults, mappings));
//
		...
		// TI1
		dataSetDefinition.addColumn("TI1", "TI1-Number of clients eligible for CD4 count during the inclusion period",
				EptsReportUtils.map(tb7Indicator1, mappings), "");

		addRow(dataSetDefinition, "EL", "Number of clients eligible for CD4 count during the inclusion period",
				EptsReportUtils.map(tb7Indicator1, mappings), getColumns());

		dataSetDefinition.addColumn("TI1-newlyOnArt",
				"TI1-Number of clients eligible for CD4 count during the inclusion period - Newly On Art",
				EptsReportUtils.map(tb7Indicator1, mappings), "cascadeOneIndicatorOneDimension=artInitiation");

		dataSetDefinition.addColumn("TI1-pregnant",
				"TI1-Number of clients eligible for CD4 count during the inclusion period - Pregnant",
				EptsReportUtils.map(tb7Indicator1, mappings), "cascadeOneIndicatorOneDimension=pregnant");

		dataSetDefinition.addColumn("TI1-consecutiveHighVL",
				"TI1-Number of clients eligible for CD4 count during the inclusion period - Consecutive High VL",
				EptsReportUtils.map(tb7Indicator1, mappings), "cascadeOneIndicatorOneDimension=consecutiveHighVL");

		dataSetDefinition.addColumn("TI1-artRestart",
				"TI1-Number of clients eligible for CD4 count during the inclusion period - Art Restart",
				EptsReportUtils.map(tb7Indicator1, mappings), "cascadeOneIndicatorOneDimension=artRestart");

		// TI2
		dataSetDefinition.addColumn("TI2",
		...
		addRow(dataSetDefinition, "RL",
				"TI2-Number of clients eligible for CD4 count who have a CD4 count result during the inclusion period",
				EptsReportUtils.map(tb7Indicator2, mappings), getColumns());

		dataSetDefinition.addColumn("TI2-newlyOnArt",
				"TI2-Number of clients eligible for CD4 count who have a CD4 count result during the inclusion period - Newly On Art",
				EptsReportUtils.map(tb7Indicator2, mappings), "cascadeOneIndicatorTwoDimension=artInitiation");

		dataSetDefinition.addColumn("TI2-pregnant",
				"TI2-Number of clients eligible for CD4 count who have a CD4 count result during the inclusion period - Pregnant",
				EptsReportUtils.map(tb7Indicator2, mappings), "cascadeOneIndicatorTwoDimension=pregnant");

		dataSetDefinition.addColumn("TI2-consecutiveHighVL",
				"TI2-Number of clients eligible for CD4 count who have a CD4 count result during the inclusion period - Consecutive High VL",
				EptsReportUtils.map(tb7Indicator2, mappings), "cascadeOneIndicatorOneDimension=consecutiveHighVL");

		dataSetDefinition.addColumn("TI2-artRestart",
				"TI2-Number of clients eligible for CD4 count who have a CD4 count result during the inclusion period - Art Restart",
				EptsReportUtils.map(tb7Indicator2, mappings), "cascadeOneIndicatorOneDimension=artRestart");

		dataSetDefinition.addColumn("TI3",
		...
		dataSetDefinition.addColumn("TITBLAM3",
		...
		dataSetDefinition.addColumn("TINTBLAM3",
		...
		// getColumns());
		//
		dataSetDefinition.addColumn("TINCD4TBLAM3", "TINCD4TBLAM3 - Indicator 3 without cd4 with TBLAM",
				EptsReportUtils.map(tb7Indicator3WithoutCd4WithTbLam, mappings), "");

		dataSetDefinition.addColumn("TINOTCD4TBLAM", "TINOTCD4TBLAM - Indicator 3 without cd4 with TBLAM(Total)",
				EptsReportUtils.map(tb7Indicator3WithoutCd4WithTbLamTotal, mappings), "");

		dataSetDefinition.addColumn("TINOTCD4NOTTBLAM",
	...
	private List<ColumnParameters> getColumns() {
		...
		ColumnParameters unknownF = new ColumnParameters("unknownF", "Unknown age", "gender=F|age=UK", "07");
		...
		ColumnParameters unknownM = new ColumnParameters("unknownF", "Unknown age", "gender=M|age=UK", "14");
