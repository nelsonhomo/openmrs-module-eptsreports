...
public class TB7AdvancedDiseaseAndTBDataSet extends BaseDataSet {
  ...
  public DataSetDefinition constructDataset() {
    ...
    // dataSetDefinition.addDimension("gender",
    // EptsReportUtils.map(eptsCommonDimension.gender(),
    // ""));
    //
    ...
    // this.eptsGeneralIndicator.getIndicator(
    // "TB7", EptsReportUtils.map(tb7CohortIndicator3WithoutCd4WithTbLam,
    // mappings));
    //
    // final CohortIndicator tb7Indicator3WithoutCd4WithTbLamTotal =
    // this.eptsGeneralIndicator.getIndicator(
    // "TB7", EptsReportUtils.map(tb7CohortIndicator3WithoutCd4WithTbLamTotal,
    // mappings));
    //
    // final CohortIndicator tb7Indicator3WithoutCd4WithoutTbLamTotal =
    // this.eptsGeneralIndicator.getIndicator(
    // "TB7", EptsReportUtils.map(tb7CohortIndicator3WithoutCd4WithoutTbLamTotal,
    // mappings));
    //
    // final CohortIndicator tb7IndicatorpatienWithoutCD4CountButWithTBLAMResults =
    // this.eptsGeneralIndicator.getIndicator(
    // "TB7", EptsReportUtils.map(patienWithoutCD4CountButWithTBLAMResults,
    // mappings));
    //
    ...
    // dataSetDefinition.addColumn(
    // "TI2",
    // "TI2-Number of clients eligible for CD4 count who have a CD4 count result
    // during the
    // inclusion period",
    ...
    // dataSetDefinition,
    // "RL",
    // "Number of clients eligible for CD4 count who have a CD4 count result during
    // the
    // inclusion period",
    // EptsReportUtils.map(
    // eptsGeneralIndicator.getIndicator(
    ...
    // dataSetDefinition.addColumn(
    // "TI3",
    // "TI3-Number of clients with CD4 count during inclusion period showing severe
    // immunodepression",
