...
import org.openmrs.module.eptsreports.reporting.calculation.util.processor.DSDLastFilaProcessor;
import org.openmrs.module.reporting.evaluation.EvaluationContext;
import org.springframework.stereotype.Component;

@Component
public class DSDLastFilaCalculation extends BaseFghCalculation {
  ...
  public CalculationResultMap evaluate(
    ...
    Map<Integer, Date> lastFilaProcessorResults =
        Context.getRegisteredComponents(DSDLastFilaProcessor.class)
            .get(0)
