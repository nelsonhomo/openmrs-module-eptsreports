...
public class SetupMERSemiAnnualReport extends EptsDataExportManager {
	...
	public List<ReportDesign> constructReportDesigns(ReportDefinition reportDefinition) {
		...
		try {
			reportDesign = createXlsReportDesign(reportDefinition, "PEPFAR_MER_2.6_Semiannual.xls",
					"PEPFAR MER 2.6 Semi-Annual Report", getExcelDesignUuid(), null);
