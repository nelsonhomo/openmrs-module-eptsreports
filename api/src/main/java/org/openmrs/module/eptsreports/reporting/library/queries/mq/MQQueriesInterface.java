  ...
  class QUERY {
    ...
    public static final String findPatientWhoAreTBActiveASixMonthfterLastConsultationRF13_1 =
        "SELECT TPI3HP.patient_id FROM  (  "
            ...
            + "INNER JOIN encounter e ON e.patient_id = p.patient_id  "
            + "INNER JOIN obs o ON o.encounter_id = e.encounter_id  "
            + "INNER JOIN obs obsStart on obsStart.encounter_id=e.encounter_id  "
            + "WHERE p.voided = 0 AND e.voided = 0 AND o.voided = 0 AND e.encounter_type = 6 AND e.location_id = :location "
            + "AND o.concept_id = 23985 AND o.value_coded=23954  "
            + "AND obsStart.concept_id=165308 AND obsStart.value_coded=1256 AND obsStart.voided=0  "
            + "AND DATE(e.encounter_datetime) BETWEEN :startInclusionDate AND :endInclusionDate "
            + "GROUP BY p.patient_id  "
            + ") TPI3HP  "
            ...
            + "AND  e.encounter_datetime BETWEEN TPI3HP.encounter_datetime AND (TPI3HP.encounter_datetime + INTERVAL 6 MONTH) "
    ...
    public static final String findPatientWhoAreTBScreeningSixMonthfterLastConsultationRF13_1 =
        "SELECT TPI3HP.patient_id FROM  (  "
            ...
            + "AND o.concept_id = 23985 AND o.value_coded=23954  "
            + "AND obsStart.concept_id=165308 AND obsStart.value_coded=1256 AND obsStart.voided=0  "
            + "AND DATE(e.encounter_datetime) BETWEEN :startInclusionDate AND :endInclusionDate GROUP BY p.patient_id  "
            + ") TPI3HP  "
            + " INNER JOIN encounter e ON e.patient_id = TPI3HP.patient_id "
            + " INNER JOIN obs obsTBPositivo ON obsTBPositivo.encounter_id = e.encounter_id "
