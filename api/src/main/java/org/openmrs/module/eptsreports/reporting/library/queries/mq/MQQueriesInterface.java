...
public interface MQQueriesInterface {
  ...
  class QUERY {
    ...
    //            + " WHERE p.voided = 0 AND e.voided = 0 AND obsTPI.voided = 0 AND e.encounter_type
    // = 6 AND e.location_id = :location "
    //            + " AND obsTPI.concept_id = 6122 AND obsTPI.value_coded = 1256 "
    //            + " AND DATE(obsTPI.obs_datetime) BETWEEN :startInclusionDate AND
    // :endInclusionDate "
    //            + " GROUP BY p.patient_id "
    //            + " UNION "
    ...
    //            + " WHERE p.voided = 0 AND e.voided = 0 AND obsTPIFIM.voided = 0 AND
    // e.encounter_type = 53 AND e.location_id = :location "
    //            + " AND obsTPIFIM.concept_id = 6128 AND DATE(obsTPIFIM.value_datetime "
    //            + ") BETWEEN :startInclusionDate AND :endInclusionDate "
    //            + " GROUP BY p.patient_id "
    //            + ") TPI ";
    ...
    public static final String findPatientWhoStartTPINHDuringPeriodCategory7 =
        " SELECT DISTINCT patient_id FROM "
            ...
            + " INNER JOIN encounter e ON e.patient_id = p.patient_id "
            + " INNER JOIN obs obsTPI ON obsTPI.encounter_id = e.encounter_id "
            + " WHERE p.voided = 0 AND e.voided = 0 AND obsTPI.voided = 0 AND e.encounter_type = 53 AND e.location_id = :location "
            + " AND obsTPI.concept_id = 23985 AND obsTPI.value_coded = 656 "
            + " AND DATE(e.encounter_datetime) BETWEEN :startInclusionDate AND :endInclusionDate "
            + " GROUP BY p.patient_id "
            + " UNION "
            + " SELECT p.patient_id,MAX(obsTPI.value_datetime) FROM patient p "
            + " INNER JOIN encounter e ON e.patient_id = p.patient_id "
            + " INNER JOIN obs obsTPI ON obsTPI.encounter_id = e.encounter_id "
            + " WHERE p.voided = 0 AND e.voided = 0 AND obsTPI.voided = 0 AND e.encounter_type = 53 AND e.location_id = :location "
            + " AND obsTPI.concept_id = 6128 "
            + " AND DATE(obsTPI.value_datetime) BETWEEN :startInclusionDate AND :endInclusionDate "
            + " GROUP BY p.patient_id "
            + " UNION "
            + " SELECT p.patient_id,MAX(e.encounter_datetime) FROM patient p "
            + " INNER JOIN encounter e ON e.patient_id = p.patient_id "
    ...
    public static final String findPatientWhoCompleteTPIINHCategory7 =
        "select DISTINCT patient_id from ( "
            ...
            + "GROUP BY p.patient_id  "
            + "UNION  "
            + "SELECT p.patient_id,MAX(obsTPI.value_datetime) AS dataInicioTPI FROM patient p  "
            + "INNER JOIN encounter e ON e.patient_id = p.patient_id  "
            + "INNER JOIN obs obsTPI ON obsTPI.encounter_id = e.encounter_id  "
            + " WHERE p.voided = 0 AND e.voided = 0 AND obsTPI.voided = 0 AND e.encounter_type = 53 AND e.location_id = :location  AND obsTPI.concept_id = 6128  "
            + "AND DATE(obsTPI.value_datetime) BETWEEN :startInclusionDate AND :endInclusionDate  "
            + "GROUP BY p.patient_id  "
            + "UNION  "
            + "SELECT p.patient_id,MAX(e.encounter_datetime) AS dataInicioTPI FROM patient p  "
            ...
            + "SELECT obs.person_id, MAX(obs_datetime) obs_datetime FROM obs obs "
            ...
            + "and obs.concept_id = 165308  "
            + "and obs.value_coded = 1256 "
            + "and obsTPI.concept_id=23985 "
            + "and obsTPI.value_coded=656 "
            + "and obsTPI.voided=0 "
            + "and e.location_id = :location  "
            + "and DATE(obs.obs_datetime) between :startInclusionDate AND :endRevisionDate  "
            + "group by obs.person_id  "
            + "UNION  "
            + "SELECT obs.person_id,MAX(value_datetime) obs_datetime FROM obs obs  "
            + "INNER JOIN encounter e ON e.encounter_id = obs.encounter_id  "
            + "INNER JOIN obs obsTPI on obsTPI.encounter_id=e.encounter_id  "
            + "where obs.voided = 0  "
            + "and e.voided = 0  "
            + "and e.encounter_type = 53  "
            + "and obs.concept_id = 6129  "
            + "and obsTPI.concept_id=23985 "
            + "and obsTPI.value_coded=656 "
            + "and obsTPI.voided=0 "
            + "and e.location_id = :location  "
            + "and DATE(obs.value_datetime) between :startInclusionDate AND :endRevisionDate  "
            + "group by obs.person_id "
            + ") maxfimtpi "
            + "group by person_id  "
            ...
            + "WHERE  "
            //            + "obsFimTPI.obs_datetime between (B4_1_2.dataInicioTPI + INTERVAL 170
            // DAY) and (B4_1_2.dataInicioTPI + INTERVAL 297 DAY) and  "
    ...
    public static final String findPatientWhoStartTPI3HPDuringPeriodCategory7 =
        " SELECT DISTINCT patient_id FROM "
            ...
            + " INNER JOIN obs obsTPI ON obsTPI.encounter_id = e.encounter_id "
            + " WHERE p.voided = 0 AND e.voided = 0 AND obsTPI.voided = 0 AND e.encounter_type = 53 AND e.location_id = :location "
            + " AND obsTPI.concept_id = 23985 AND obsTPI.value_coded = 23954 "
            + " AND DATE(e.encounter_datetime) BETWEEN :startInclusionDate AND :endInclusionDate "
            + " GROUP BY p.patient_id "
            + " UNION "
            + " SELECT p.patient_id,MAX(e.encounter_datetime) FROM patient p "
    ...
    public static final String findPatientWhoCompleteTPI3HPCategory7 =
        "select DISTINCT patient_id from ( "
            ...
            + "left join obs obsTBActiva on obsTBActiva.person_id= B4_1_2.patient_id and obsTBActiva.voided = 0 and  "
            + "obsTBActiva.concept_id = 23761 and obsTBActiva.value_coded = 1065 and  "
            + "obsTBActiva.obs_datetime between B4_1_2.dataInicioTPI and (B4_1_2.dataInicioTPI + INTERVAL 6 MONTH) and obsTBActiva.location_id = :location  "
            + "left join obs obsRastreio on obsRastreio.person_id = B4_1_2.patient_id and obsRastreio.voided = 0 and  "
            + "obsRastreio.concept_id = 23758 and obsRastreio.value_coded = 1065 and  "
            + "obsRastreio.obs_datetime between B4_1_2.dataInicioTPI and (B4_1_2.dataInicioTPI + INTERVAL 6 MONTH) and obsRastreio.location_id = :location  "
            + "left join obs obsTB on obsTB.person_id = B4_1_2.patient_id and obsTB.voided = 0 and  "
            + "obsTB.concept_id = 1268 and obsTB.value_coded in (1256,1257,1267) and  "
            + "obsTB.obs_datetime between B4_1_2.dataInicioTPI and (B4_1_2.dataInicioTPI + INTERVAL 6 MONTH) and obsTB.location_id = :location  "
            + "WHERE  "
            //            + "obsFimTPI.obs_datetime between (B4_1_2.dataInicioTPI + INTERVAL 170
            // DAY) and (B4_1_2.dataInicioTPI + INTERVAL 297 DAY) and  "
            + "obsTBActiva.person_id is null and  "
    ...
    //        " select DISTINCT patient_id from( "
    //            + " select B4_1_2.patient_id, B4_1_2.dataInicioTPI, obsFimTPI.obs_datetime
    // dataFimTPI, "
    //            + " obsTBActiva.obs_datetime dataTBActiva, obsRastreio.obs_datetime
    // dataRastreioPositivo, obsTB.obs_datetime dataTB from ( "
    //            + " SELECT patient_id, MAX(dataInicioTPI) dataInicioTPI FROM ( "
    //            + " SELECT p.patient_id, MAX(e.encounter_datetime) AS dataInicioTPI FROM patient p
    // "
    //            + " INNER JOIN encounter e ON e.patient_id = p.patient_id "
    ...
    //            + " WHERE p.voided = 0 AND e.voided = 0 AND obsTPI.voided = 0 AND e.encounter_type
    // = 6 AND e.location_id = :location "
    //            + " AND obsTPI.concept_id = 6122 AND obsTPI.value_coded = 1256 AND
    // DATE(obsTPI.obs_datetime) BETWEEN :startInclusionDate AND :endInclusionDate "
    //            + " GROUP BY p.patient_id "
    //            + " UNION "
    //            + " SELECT p.patient_id, MAX(obsTPIFIM.value_datetime) AS dataInicioTPI FROM
    // patient p "
    //            + " INNER JOIN encounter e ON e.patient_id = p.patient_id "
    //            + " INNER JOIN obs obsTPIFIM ON obsTPIFIM.encounter_id = e.encounter_id "
    //            + " WHERE p.voided = 0 AND e.voided = 0 AND obsTPIFIM.voided = 0 AND
    // e.encounter_type = 53 AND e.location_id = :location "
    //            + " AND obsTPIFIM.concept_id = 6128 AND DATE(obsTPIFIM.value_datetime) BETWEEN
    // :startInclusionDate AND :endInclusionDate "
    //            + " GROUP BY p.patient_id  "
    //            + " )maxdatainicio GROUP BY patient_id  "
    //            + " ) B4_1_2 "
    //            + " inner join "
    ...
    //            + " obs obs "
    //            + " INNER JOIN encounter e ON e.encounter_id = obs.encounter_id "
    //            + " where obs.voided = 0 and e.voided = 0 and obs.location_id = :location and
    // obs.concept_id = 6122 and obs.value_coded = 1267 and "
    ...
    //            + " obs obs "
    //            + " INNER JOIN encounter e ON e.encounter_id = obs.encounter_id "
    //            + " where obs.voided = 0 and e.voided = 0 and obs.concept_id = 6129 and
    // obs.location_id = :location and "
    //            + " e.encounter_type = 53 and e.location_id = :location and "
    //            + " DATE(obs.value_datetime) between :startInclusionDate AND :endRevisionDate "
    //            + " group by obs.person_id "
    //            + " ) maxfimtpi group by person_id "
    //            + " ) obsFimTPI on obsFimTPI.person_id = B4_1_2.patient_id "
    //            + " left join obs obsTBActiva on obsTBActiva.person_id= B4_1_2.patient_id and
    // obsTBActiva.voided = 0 and "
    //            + " obsTBActiva.concept_id = 23761 and obsTBActiva.value_coded = 1065 and "
    //            + " obsTBActiva.obs_datetime between B4_1_2.dataInicioTPI and
    // (B4_1_2.dataInicioTPI + INTERVAL 9 MONTH) and obsTBActiva.location_id = :location "
    //            + " left join obs obsRastreio on obsRastreio.person_id = B4_1_2.patient_id and
    // obsRastreio.voided = 0 and "
    //            + " obsRastreio.concept_id = 23758 and obsRastreio.value_coded = 1065 and "
    //            + " obsRastreio.obs_datetime between B4_1_2.dataInicioTPI and
    // (B4_1_2.dataInicioTPI + INTERVAL 9 MONTH) and obsRastreio.location_id = :location "
    //            + " left join obs obsTB on obsTB.person_id = B4_1_2.patient_id and obsTB.voided =
    // 0 and "
    //            + " obsTB.concept_id = 1268 and obsTB.value_coded in (1256,1257,1267) and "
    //            + " obsTB.obs_datetime between B4_1_2.dataInicioTPI and (B4_1_2.dataInicioTPI +
    // INTERVAL 9 MONTH) and obsTB.location_id = :location "
    //            + " WHERE "
    //            + " obsFimTPI.obs_datetime between (B4_1_2.dataInicioTPI + INTERVAL 170 DAY) and
    // (B4_1_2.dataInicioTPI + INTERVAL 297 DAY) and "
    //            + " obsTBActiva.person_id is null and "
    //            + " obsRastreio.person_id is null and "
    //            + " obsTB.person_id is null "
    //            + " )finalTPI ";
