...
public interface MQCategory15QueriesInterface {
  ...
  class QUERY {
    ...
    public static final String findPatientsWhoOnARTAndHaveCVBiggerThan1000AndWhoSuspendTratment =
        "select result.patient_id from ( "
            + "select cv.patient_id,cv.data_ultima_consulta,cv.data_cv,cv.valor, fila.data_levantamento,fila.data_proximo_levantamento, DATEDIFF(fila.data_proximo_levantamento,fila.data_levantamento) from "
            + "( "
