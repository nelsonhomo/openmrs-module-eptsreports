  ...
  class QUERY {
    ...
    public static final String findPatientsWhoOnARTAndHaveCVBiggerThan1000AndWhoSuspendTratment =
        "select result.patient_id from ( "
            ...
            + ")clinica "
            + "where  (clinica.clinica.data_proxima_consulta>=cv.data_ultima_consulta and clinica.clinica.data_proxima_consulta<=:endRevisionDate ) and (DATEDIFF(clinica.data_proxima_consulta,clinica.data_consulta) >= 23) "
