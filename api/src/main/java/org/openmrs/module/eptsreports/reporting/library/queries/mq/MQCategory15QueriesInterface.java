    ...
    public static final String
        findPatientsWithDispensaTrimestralInicarInFichaClinicaDuringTheRevisionPeriodA2 =
            "select f.patient_id from ( "
                ...
                + "join obs o on o.encounter_id=e.encounter_id   "
                + "join obs obsEstado on obsEstado.encounter_id=e.encounter_id  "
                + "where  e.encounter_type in(6) and e.location_id=:location and o.concept_id=165174 "
                + "and o.value_coded in(23730) and o.voided=0  "
                + "and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  "
                + "and obsEstado.value_coded =1256  and obsEstado.voided=0  and grupo.voided=0  "
